...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	691040ef          	jal	ra,ffffffffc0204eda <memset>
...
ffffffffc0200056:	ed658593          	addi	a1,a1,-298 # ffffffffc0204f28 <etext>
ffffffffc020005a:	00005517          	auipc	a0,0x5
ffffffffc020005e:	eee50513          	addi	a0,a0,-274 # ffffffffc0204f48 <etext+0x20>
...
ffffffffc02000ac:	ea850513          	addi	a0,a0,-344 # ffffffffc0204f50 <etext+0x28>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	169040ef          	jal	ra,ffffffffc0204adc <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	133040ef          	jal	ra,ffffffffc0204adc <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	d8e50513          	addi	a0,a0,-626 # ffffffffc0204f58 <etext+0x30>
void print_kerninfo(void) {
...
ffffffffc02001e4:	d9850513          	addi	a0,a0,-616 # ffffffffc0204f78 <etext+0x50>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	d3c58593          	addi	a1,a1,-708 # ffffffffc0204f28 <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	da450513          	addi	a0,a0,-604 # ffffffffc0204f98 <etext+0x70>
...
ffffffffc020020c:	db050513          	addi	a0,a0,-592 # ffffffffc0204fb8 <etext+0x90>
...
ffffffffc0200220:	dbc50513          	addi	a0,a0,-580 # ffffffffc0204fd8 <etext+0xb0>
...
ffffffffc020024e:	dae50513          	addi	a0,a0,-594 # ffffffffc0204ff8 <etext+0xd0>
}
...
ffffffffc020025c:	dd060613          	addi	a2,a2,-560 # ffffffffc0205028 <etext+0x100>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	ddc50513          	addi	a0,a0,-548 # ffffffffc0205040 <etext+0x118>
void print_stackframe(void) {
...
ffffffffc0200278:	de460613          	addi	a2,a2,-540 # ffffffffc0205058 <etext+0x130>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	dfc58593          	addi	a1,a1,-516 # ffffffffc0205078 <etext+0x150>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	dfc50513          	addi	a0,a0,-516 # ffffffffc0205080 <etext+0x158>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	dfe60613          	addi	a2,a2,-514 # ffffffffc0205090 <etext+0x168>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	e1e58593          	addi	a1,a1,-482 # ffffffffc02050b8 <etext+0x190>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	dde50513          	addi	a0,a0,-546 # ffffffffc0205080 <etext+0x158>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	e1a60613          	addi	a2,a2,-486 # ffffffffc02050c8 <etext+0x1a0>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	e3258593          	addi	a1,a1,-462 # ffffffffc02050e8 <etext+0x1c0>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	dc250513          	addi	a0,a0,-574 # ffffffffc0205080 <etext+0x158>
...
ffffffffc02002fc:	e0050513          	addi	a0,a0,-512 # ffffffffc02050f8 <etext+0x1d0>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	e0650513          	addi	a0,a0,-506 # ffffffffc0205120 <etext+0x1f8>
...
ffffffffc0200348:	e0490913          	addi	s2,s2,-508 # ffffffffc0205148 <etext+0x220>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	e0448493          	addi	s1,s1,-508 # ffffffffc0205150 <etext+0x228>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	e02b0b13          	addi	s6,s6,-510 # ffffffffc0205158 <etext+0x230>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	d1aa0a13          	addi	s4,s4,-742 # ffffffffc0205078 <etext+0x150>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	319040ef          	jal	ra,ffffffffc0204ea6 <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	305040ef          	jal	ra,ffffffffc0204ea6 <strcmp>
...
ffffffffc02003e0:	2e5040ef          	jal	ra,ffffffffc0204ec4 <strchr>
...
ffffffffc020041e:	2a7040ef          	jal	ra,ffffffffc0204ec4 <strchr>
...
ffffffffc020043c:	d4050513          	addi	a0,a0,-704 # ffffffffc0205178 <etext+0x250>
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	161040ef          	jal	ra,ffffffffc0204eec <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	13d040ef          	jal	ra,ffffffffc0204eec <memcpy>
    return 0;
}
...
ffffffffc0201440:	7ec68693          	addi	a3,a3,2028 # ffffffffc0205c28 <commands+0xa98>
ffffffffc0201444:	00004617          	auipc	a2,0x4
ffffffffc0201448:	48460613          	addi	a2,a2,1156 # ffffffffc02058c8 <commands+0x738>
ffffffffc020144c:	08300593          	li	a1,131
ffffffffc0201450:	00004517          	auipc	a0,0x4
ffffffffc0201454:	49050513          	addi	a0,a0,1168 # ffffffffc02058e0 <commands+0x750>
ffffffffc0201458:	feffe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc020145c:	00004697          	auipc	a3,0x4
ffffffffc0201460:	7c468693          	addi	a3,a3,1988 # ffffffffc0205c20 <commands+0xa90>
ffffffffc0201464:	00004617          	auipc	a2,0x4
ffffffffc0201468:	46460613          	addi	a2,a2,1124 # ffffffffc02058c8 <commands+0x738>
ffffffffc020146c:	08000593          	li	a1,128
ffffffffc0201470:	00004517          	auipc	a0,0x4
ffffffffc0201474:	47050513          	addi	a0,a0,1136 # ffffffffc02058e0 <commands+0x750>
...
ffffffffc0201512:	71268693          	addi	a3,a3,1810 # ffffffffc0205c20 <commands+0xa90>
ffffffffc0201516:	00004617          	auipc	a2,0x4
ffffffffc020151a:	3b260613          	addi	a2,a2,946 # ffffffffc02058c8 <commands+0x738>
ffffffffc020151e:	06200593          	li	a1,98
ffffffffc0201522:	00004517          	auipc	a0,0x4
ffffffffc0201526:	3be50513          	addi	a0,a0,958 # ffffffffc02058e0 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc02015e4:	67068693          	addi	a3,a3,1648 # ffffffffc0205c50 <commands+0xac0>
ffffffffc02015e8:	00004617          	auipc	a2,0x4
ffffffffc02015ec:	2e060613          	addi	a2,a2,736 # ffffffffc02058c8 <commands+0x738>
ffffffffc02015f0:	04900593          	li	a1,73
ffffffffc02015f4:	00004517          	auipc	a0,0x4
ffffffffc02015f8:	2ec50513          	addi	a0,a0,748 # ffffffffc02058e0 <commands+0x750>
ffffffffc02015fc:	e4bfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc0201600:	00004697          	auipc	a3,0x4
ffffffffc0201604:	62068693          	addi	a3,a3,1568 # ffffffffc0205c20 <commands+0xa90>
ffffffffc0201608:	00004617          	auipc	a2,0x4
ffffffffc020160c:	2c060613          	addi	a2,a2,704 # ffffffffc02058c8 <commands+0x738>
ffffffffc0201610:	04600593          	li	a1,70
ffffffffc0201614:	00004517          	auipc	a0,0x4
ffffffffc0201618:	2cc50513          	addi	a0,a0,716 # ffffffffc02058e0 <commands+0x750>
...
ffffffffc02016f4:	9186b683          	ld	a3,-1768(a3) # ffffffffc0207008 <nbase>
...
ffffffffc0201724:	59060613          	addi	a2,a2,1424 # ffffffffc0205cb0 <default_pmm_manager+0x38>
ffffffffc0201728:	06a00593          	li	a1,106
ffffffffc020172c:	00004517          	auipc	a0,0x4
ffffffffc0201730:	5ac50513          	addi	a0,a0,1452 # ffffffffc0205cd8 <default_pmm_manager+0x60>
...
ffffffffc0201812:	4da68693          	addi	a3,a3,1242 # ffffffffc0205ce8 <default_pmm_manager+0x70>
ffffffffc0201816:	00004617          	auipc	a2,0x4
ffffffffc020181a:	0b260613          	addi	a2,a2,178 # ffffffffc02058c8 <commands+0x738>
ffffffffc020181e:	06300593          	li	a1,99
ffffffffc0201822:	00004517          	auipc	a0,0x4
ffffffffc0201826:	4e650513          	addi	a0,a0,1254 # ffffffffc0205d08 <default_pmm_manager+0x90>
...
ffffffffc0201834:	4f050513          	addi	a0,a0,1264 # ffffffffc0205d20 <default_pmm_manager+0xa8>
kmalloc_init(void) {
...
ffffffffc0201844:	4f850513          	addi	a0,a0,1272 # ffffffffc0205d38 <default_pmm_manager+0xc0>
}
...
ffffffffc0201968:	6a453503          	ld	a0,1700(a0) # ffffffffc0207008 <nbase>
...
ffffffffc02019c6:	3be60613          	addi	a2,a2,958 # ffffffffc0205d80 <default_pmm_manager+0x108>
ffffffffc02019ca:	06300593          	li	a1,99
ffffffffc02019ce:	00004517          	auipc	a0,0x4
ffffffffc02019d2:	30a50513          	addi	a0,a0,778 # ffffffffc0205cd8 <default_pmm_manager+0x60>
...
ffffffffc02019e0:	37c60613          	addi	a2,a2,892 # ffffffffc0205d58 <default_pmm_manager+0xe0>
ffffffffc02019e4:	06f00593          	li	a1,111
ffffffffc02019e8:	00004517          	auipc	a0,0x4
ffffffffc02019ec:	2f050513          	addi	a0,a0,752 # ffffffffc0205cd8 <default_pmm_manager+0x60>
...
ffffffffc02019fa:	38a60613          	addi	a2,a2,906 # ffffffffc0205d80 <default_pmm_manager+0x108>
ffffffffc02019fe:	06300593          	li	a1,99
ffffffffc0201a02:	00004517          	auipc	a0,0x4
ffffffffc0201a06:	2d650513          	addi	a0,a0,726 # ffffffffc0205cd8 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0201a16:	38e60613          	addi	a2,a2,910 # ffffffffc0205da0 <default_pmm_manager+0x128>
ffffffffc0201a1a:	07500593          	li	a1,117
ffffffffc0201a1e:	00004517          	auipc	a0,0x4
ffffffffc0201a22:	2ba50513          	addi	a0,a0,698 # ffffffffc0205cd8 <default_pmm_manager+0x60>
pte2page(pte_t pte) {
...
ffffffffc0201bbe:	31c030ef          	jal	ra,ffffffffc0204eda <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	28a030ef          	jal	ra,ffffffffc0204eda <memset>
    return page - pages + nbase;
...
ffffffffc0201caa:	00a60613          	addi	a2,a2,10 # ffffffffc0205cb0 <default_pmm_manager+0x38>
ffffffffc0201cae:	0e400593          	li	a1,228
ffffffffc0201cb2:	00004517          	auipc	a0,0x4
ffffffffc0201cb6:	11650513          	addi	a0,a0,278 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc0201cba:	f8cfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201cbe:	00004617          	auipc	a2,0x4
ffffffffc0201cc2:	ff260613          	addi	a2,a2,-14 # ffffffffc0205cb0 <default_pmm_manager+0x38>
ffffffffc0201cc6:	0ef00593          	li	a1,239
ffffffffc0201cca:	00004517          	auipc	a0,0x4
ffffffffc0201cce:	0fe50513          	addi	a0,a0,254 # ffffffffc0205dc8 <default_pmm_manager+0x150>
...
ffffffffc0201cdc:	fd860613          	addi	a2,a2,-40 # ffffffffc0205cb0 <default_pmm_manager+0x38>
ffffffffc0201ce0:	0ec00593          	li	a1,236
ffffffffc0201ce4:	00004517          	auipc	a0,0x4
ffffffffc0201ce8:	0e450513          	addi	a0,a0,228 # ffffffffc0205dc8 <default_pmm_manager+0x150>
...
ffffffffc0201cf6:	fbe60613          	addi	a2,a2,-66 # ffffffffc0205cb0 <default_pmm_manager+0x38>
ffffffffc0201cfa:	0e100593          	li	a1,225
ffffffffc0201cfe:	00004517          	auipc	a0,0x4
ffffffffc0201d02:	0ca50513          	addi	a0,a0,202 # ffffffffc0205dc8 <default_pmm_manager+0x150>
...
ffffffffc0201ef4:	d8878793          	addi	a5,a5,-632 # ffffffffc0205c78 <default_pmm_manager>
...
ffffffffc0201f02:	eda50513          	addi	a0,a0,-294 # ffffffffc0205dd8 <default_pmm_manager+0x160>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201f50:	ea450513          	addi	a0,a0,-348 # ffffffffc0205df0 <default_pmm_manager+0x178>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201f70:	e9c50513          	addi	a0,a0,-356 # ffffffffc0205e08 <default_pmm_manager+0x190>
...
ffffffffc0201fd8:	e5c50513          	addi	a0,a0,-420 # ffffffffc0205e30 <default_pmm_manager+0x1b8>
...
ffffffffc0201ff4:	e5850513          	addi	a0,a0,-424 # ffffffffc0205e48 <default_pmm_manager+0x1d0>
...
ffffffffc0202294:	ea050513          	addi	a0,a0,-352 # ffffffffc0206130 <default_pmm_manager+0x4b8>
...
ffffffffc020234a:	f2258593          	addi	a1,a1,-222 # ffffffffc0206268 <default_pmm_manager+0x5f0>
ffffffffc020234e:	10000513          	li	a0,256
ffffffffc0202352:	343020ef          	jal	ra,ffffffffc0204e94 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	349020ef          	jal	ra,ffffffffc0204ea6 <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	2cb020ef          	jal	ra,ffffffffc0204e5e <strlen>
...
ffffffffc0202458:	e8c50513          	addi	a0,a0,-372 # ffffffffc02062e0 <default_pmm_manager+0x668>
...
ffffffffc0202572:	c2268693          	addi	a3,a3,-990 # ffffffffc0206190 <default_pmm_manager+0x518>
ffffffffc0202576:	00003617          	auipc	a2,0x3
ffffffffc020257a:	35260613          	addi	a2,a2,850 # ffffffffc02058c8 <commands+0x738>
ffffffffc020257e:	19e00593          	li	a1,414
ffffffffc0202582:	00004517          	auipc	a0,0x4
ffffffffc0202586:	84650513          	addi	a0,a0,-1978 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc020258a:	ebdfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc020258e:	00004697          	auipc	a3,0x4
ffffffffc0202592:	bc268693          	addi	a3,a3,-1086 # ffffffffc0206150 <default_pmm_manager+0x4d8>
ffffffffc0202596:	00003617          	auipc	a2,0x3
ffffffffc020259a:	33260613          	addi	a2,a2,818 # ffffffffc02058c8 <commands+0x738>
ffffffffc020259e:	19d00593          	li	a1,413
ffffffffc02025a2:	00004517          	auipc	a0,0x4
ffffffffc02025a6:	82650513          	addi	a0,a0,-2010 # ffffffffc0205dc8 <default_pmm_manager+0x150>
...
ffffffffc02025b4:	70060613          	addi	a2,a2,1792 # ffffffffc0205cb0 <default_pmm_manager+0x38>
ffffffffc02025b8:	19d00593          	li	a1,413
ffffffffc02025bc:	00004517          	auipc	a0,0x4
ffffffffc02025c0:	80c50513          	addi	a0,a0,-2036 # ffffffffc0205dc8 <default_pmm_manager+0x150>
...
ffffffffc02025d0:	78c60613          	addi	a2,a2,1932 # ffffffffc0205d58 <default_pmm_manager+0xe0>
ffffffffc02025d4:	07f00593          	li	a1,127
ffffffffc02025d8:	00003517          	auipc	a0,0x3
ffffffffc02025dc:	7f050513          	addi	a0,a0,2032 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc02025e0:	e67fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc02025e4:	00003617          	auipc	a2,0x3
ffffffffc02025e8:	77460613          	addi	a2,a2,1908 # ffffffffc0205d58 <default_pmm_manager+0xe0>
ffffffffc02025ec:	0c300593          	li	a1,195
ffffffffc02025f0:	00003517          	auipc	a0,0x3
ffffffffc02025f4:	7d850513          	addi	a0,a0,2008 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc02025f8:	e4ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc02025fc:	00004697          	auipc	a3,0x4
ffffffffc0202600:	88c68693          	addi	a3,a3,-1908 # ffffffffc0205e88 <default_pmm_manager+0x210>
ffffffffc0202604:	00003617          	auipc	a2,0x3
ffffffffc0202608:	2c460613          	addi	a2,a2,708 # ffffffffc02058c8 <commands+0x738>
ffffffffc020260c:	16100593          	li	a1,353
ffffffffc0202610:	00003517          	auipc	a0,0x3
ffffffffc0202614:	7b850513          	addi	a0,a0,1976 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc0202618:	e2ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020261c:	00004697          	auipc	a3,0x4
ffffffffc0202620:	84c68693          	addi	a3,a3,-1972 # ffffffffc0205e68 <default_pmm_manager+0x1f0>
ffffffffc0202624:	00003617          	auipc	a2,0x3
ffffffffc0202628:	2a460613          	addi	a2,a2,676 # ffffffffc02058c8 <commands+0x738>
ffffffffc020262c:	16000593          	li	a1,352
ffffffffc0202630:	00003517          	auipc	a0,0x3
ffffffffc0202634:	79850513          	addi	a0,a0,1944 # ffffffffc0205dc8 <default_pmm_manager+0x150>
...
ffffffffc0202644:	8d868693          	addi	a3,a3,-1832 # ffffffffc0205f18 <default_pmm_manager+0x2a0>
ffffffffc0202648:	00003617          	auipc	a2,0x3
ffffffffc020264c:	28060613          	addi	a2,a2,640 # ffffffffc02058c8 <commands+0x738>
ffffffffc0202650:	16900593          	li	a1,361
ffffffffc0202654:	00003517          	auipc	a0,0x3
ffffffffc0202658:	77450513          	addi	a0,a0,1908 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc020265c:	debfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202660:	00004697          	auipc	a3,0x4
ffffffffc0202664:	88868693          	addi	a3,a3,-1912 # ffffffffc0205ee8 <default_pmm_manager+0x270>
ffffffffc0202668:	00003617          	auipc	a2,0x3
ffffffffc020266c:	26060613          	addi	a2,a2,608 # ffffffffc02058c8 <commands+0x738>
ffffffffc0202670:	16600593          	li	a1,358
ffffffffc0202674:	00003517          	auipc	a0,0x3
ffffffffc0202678:	75450513          	addi	a0,a0,1876 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc020267c:	dcbfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc0202680:	00004697          	auipc	a3,0x4
ffffffffc0202684:	84068693          	addi	a3,a3,-1984 # ffffffffc0205ec0 <default_pmm_manager+0x248>
ffffffffc0202688:	00003617          	auipc	a2,0x3
ffffffffc020268c:	24060613          	addi	a2,a2,576 # ffffffffc02058c8 <commands+0x738>
ffffffffc0202690:	16200593          	li	a1,354
ffffffffc0202694:	00003517          	auipc	a0,0x3
ffffffffc0202698:	73450513          	addi	a0,a0,1844 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc020269c:	dabfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02026a0:	00004697          	auipc	a3,0x4
ffffffffc02026a4:	90068693          	addi	a3,a3,-1792 # ffffffffc0205fa0 <default_pmm_manager+0x328>
ffffffffc02026a8:	00003617          	auipc	a2,0x3
ffffffffc02026ac:	22060613          	addi	a2,a2,544 # ffffffffc02058c8 <commands+0x738>
ffffffffc02026b0:	17200593          	li	a1,370
ffffffffc02026b4:	00003517          	auipc	a0,0x3
ffffffffc02026b8:	71450513          	addi	a0,a0,1812 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc02026bc:	d8bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02026c0:	00004697          	auipc	a3,0x4
ffffffffc02026c4:	98068693          	addi	a3,a3,-1664 # ffffffffc0206040 <default_pmm_manager+0x3c8>
ffffffffc02026c8:	00003617          	auipc	a2,0x3
ffffffffc02026cc:	20060613          	addi	a2,a2,512 # ffffffffc02058c8 <commands+0x738>
ffffffffc02026d0:	17700593          	li	a1,375
ffffffffc02026d4:	00003517          	auipc	a0,0x3
ffffffffc02026d8:	6f450513          	addi	a0,a0,1780 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc02026dc:	d6bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc02026e0:	00004697          	auipc	a3,0x4
ffffffffc02026e4:	89868693          	addi	a3,a3,-1896 # ffffffffc0205f78 <default_pmm_manager+0x300>
ffffffffc02026e8:	00003617          	auipc	a2,0x3
ffffffffc02026ec:	1e060613          	addi	a2,a2,480 # ffffffffc02058c8 <commands+0x738>
ffffffffc02026f0:	16f00593          	li	a1,367
ffffffffc02026f4:	00003517          	auipc	a0,0x3
ffffffffc02026f8:	6d450513          	addi	a0,a0,1748 # ffffffffc0205dc8 <default_pmm_manager+0x150>
...
ffffffffc0202706:	5ae60613          	addi	a2,a2,1454 # ffffffffc0205cb0 <default_pmm_manager+0x38>
ffffffffc020270a:	16e00593          	li	a1,366
ffffffffc020270e:	00003517          	auipc	a0,0x3
ffffffffc0202712:	6ba50513          	addi	a0,a0,1722 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc0202716:	d31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020271a:	00004697          	auipc	a3,0x4
ffffffffc020271e:	8be68693          	addi	a3,a3,-1858 # ffffffffc0205fd8 <default_pmm_manager+0x360>
ffffffffc0202722:	00003617          	auipc	a2,0x3
ffffffffc0202726:	1a660613          	addi	a2,a2,422 # ffffffffc02058c8 <commands+0x738>
ffffffffc020272a:	17c00593          	li	a1,380
ffffffffc020272e:	00003517          	auipc	a0,0x3
ffffffffc0202732:	69a50513          	addi	a0,a0,1690 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc0202736:	d11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020273a:	00004697          	auipc	a3,0x4
ffffffffc020273e:	96668693          	addi	a3,a3,-1690 # ffffffffc02060a0 <default_pmm_manager+0x428>
ffffffffc0202742:	00003617          	auipc	a2,0x3
ffffffffc0202746:	18660613          	addi	a2,a2,390 # ffffffffc02058c8 <commands+0x738>
ffffffffc020274a:	17b00593          	li	a1,379
ffffffffc020274e:	00003517          	auipc	a0,0x3
ffffffffc0202752:	67a50513          	addi	a0,a0,1658 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc0202756:	cf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020275a:	00004697          	auipc	a3,0x4
ffffffffc020275e:	92e68693          	addi	a3,a3,-1746 # ffffffffc0206088 <default_pmm_manager+0x410>
ffffffffc0202762:	00003617          	auipc	a2,0x3
ffffffffc0202766:	16660613          	addi	a2,a2,358 # ffffffffc02058c8 <commands+0x738>
ffffffffc020276a:	17a00593          	li	a1,378
ffffffffc020276e:	00003517          	auipc	a0,0x3
ffffffffc0202772:	65a50513          	addi	a0,a0,1626 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc0202776:	cd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc020277a:	00004697          	auipc	a3,0x4
ffffffffc020277e:	8de68693          	addi	a3,a3,-1826 # ffffffffc0206058 <default_pmm_manager+0x3e0>
ffffffffc0202782:	00003617          	auipc	a2,0x3
ffffffffc0202786:	14660613          	addi	a2,a2,326 # ffffffffc02058c8 <commands+0x738>
ffffffffc020278a:	17900593          	li	a1,377
ffffffffc020278e:	00003517          	auipc	a0,0x3
ffffffffc0202792:	63a50513          	addi	a0,a0,1594 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc0202796:	cb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc020279a:	00004697          	auipc	a3,0x4
ffffffffc020279e:	a7668693          	addi	a3,a3,-1418 # ffffffffc0206210 <default_pmm_manager+0x598>
ffffffffc02027a2:	00003617          	auipc	a2,0x3
ffffffffc02027a6:	12660613          	addi	a2,a2,294 # ffffffffc02058c8 <commands+0x738>
ffffffffc02027aa:	1a700593          	li	a1,423
ffffffffc02027ae:	00003517          	auipc	a0,0x3
ffffffffc02027b2:	61a50513          	addi	a0,a0,1562 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc02027b6:	c91fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02027ba:	00004697          	auipc	a3,0x4
ffffffffc02027be:	86e68693          	addi	a3,a3,-1938 # ffffffffc0206028 <default_pmm_manager+0x3b0>
ffffffffc02027c2:	00003617          	auipc	a2,0x3
ffffffffc02027c6:	10660613          	addi	a2,a2,262 # ffffffffc02058c8 <commands+0x738>
ffffffffc02027ca:	17600593          	li	a1,374
ffffffffc02027ce:	00003517          	auipc	a0,0x3
ffffffffc02027d2:	5fa50513          	addi	a0,a0,1530 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc02027d6:	c71fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_W);
ffffffffc02027da:	00004697          	auipc	a3,0x4
ffffffffc02027de:	83e68693          	addi	a3,a3,-1986 # ffffffffc0206018 <default_pmm_manager+0x3a0>
ffffffffc02027e2:	00003617          	auipc	a2,0x3
ffffffffc02027e6:	0e660613          	addi	a2,a2,230 # ffffffffc02058c8 <commands+0x738>
ffffffffc02027ea:	17500593          	li	a1,373
ffffffffc02027ee:	00003517          	auipc	a0,0x3
ffffffffc02027f2:	5da50513          	addi	a0,a0,1498 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc02027f6:	c51fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02027fa:	00004697          	auipc	a3,0x4
ffffffffc02027fe:	91668693          	addi	a3,a3,-1770 # ffffffffc0206110 <default_pmm_manager+0x498>
ffffffffc0202802:	00003617          	auipc	a2,0x3
ffffffffc0202806:	0c660613          	addi	a2,a2,198 # ffffffffc02058c8 <commands+0x738>
ffffffffc020280a:	1b800593          	li	a1,440
ffffffffc020280e:	00003517          	auipc	a0,0x3
ffffffffc0202812:	5ba50513          	addi	a0,a0,1466 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc0202816:	c31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020281a:	00003697          	auipc	a3,0x3
ffffffffc020281e:	7ee68693          	addi	a3,a3,2030 # ffffffffc0206008 <default_pmm_manager+0x390>
ffffffffc0202822:	00003617          	auipc	a2,0x3
ffffffffc0202826:	0a660613          	addi	a2,a2,166 # ffffffffc02058c8 <commands+0x738>
ffffffffc020282a:	17400593          	li	a1,372
ffffffffc020282e:	00003517          	auipc	a0,0x3
ffffffffc0202832:	59a50513          	addi	a0,a0,1434 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc0202836:	c11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020283a:	00003697          	auipc	a3,0x3
ffffffffc020283e:	72668693          	addi	a3,a3,1830 # ffffffffc0205f60 <default_pmm_manager+0x2e8>
ffffffffc0202842:	00003617          	auipc	a2,0x3
ffffffffc0202846:	08660613          	addi	a2,a2,134 # ffffffffc02058c8 <commands+0x738>
ffffffffc020284a:	18100593          	li	a1,385
ffffffffc020284e:	00003517          	auipc	a0,0x3
ffffffffc0202852:	57a50513          	addi	a0,a0,1402 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc0202856:	bf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020285a:	00004697          	auipc	a3,0x4
ffffffffc020285e:	85e68693          	addi	a3,a3,-1954 # ffffffffc02060b8 <default_pmm_manager+0x440>
ffffffffc0202862:	00003617          	auipc	a2,0x3
ffffffffc0202866:	06660613          	addi	a2,a2,102 # ffffffffc02058c8 <commands+0x738>
ffffffffc020286a:	17e00593          	li	a1,382
ffffffffc020286e:	00003517          	auipc	a0,0x3
ffffffffc0202872:	55a50513          	addi	a0,a0,1370 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc0202876:	bd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020287a:	00003697          	auipc	a3,0x3
ffffffffc020287e:	6ce68693          	addi	a3,a3,1742 # ffffffffc0205f48 <default_pmm_manager+0x2d0>
ffffffffc0202882:	00003617          	auipc	a2,0x3
ffffffffc0202886:	04660613          	addi	a2,a2,70 # ffffffffc02058c8 <commands+0x738>
ffffffffc020288a:	17d00593          	li	a1,381
ffffffffc020288e:	00003517          	auipc	a0,0x3
ffffffffc0202892:	53a50513          	addi	a0,a0,1338 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc0202896:	bb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc020289a:	00003617          	auipc	a2,0x3
ffffffffc020289e:	41660613          	addi	a2,a2,1046 # ffffffffc0205cb0 <default_pmm_manager+0x38>
ffffffffc02028a2:	06a00593          	li	a1,106
ffffffffc02028a6:	00003517          	auipc	a0,0x3
ffffffffc02028aa:	43250513          	addi	a0,a0,1074 # ffffffffc0205cd8 <default_pmm_manager+0x60>
ffffffffc02028ae:	b99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02028b2:	00004697          	auipc	a3,0x4
ffffffffc02028b6:	83668693          	addi	a3,a3,-1994 # ffffffffc02060e8 <default_pmm_manager+0x470>
ffffffffc02028ba:	00003617          	auipc	a2,0x3
ffffffffc02028be:	00e60613          	addi	a2,a2,14 # ffffffffc02058c8 <commands+0x738>
ffffffffc02028c2:	18800593          	li	a1,392
ffffffffc02028c6:	00003517          	auipc	a0,0x3
ffffffffc02028ca:	50250513          	addi	a0,a0,1282 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc02028ce:	b79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc02028d2:	00003697          	auipc	a3,0x3
ffffffffc02028d6:	7ce68693          	addi	a3,a3,1998 # ffffffffc02060a0 <default_pmm_manager+0x428>
ffffffffc02028da:	00003617          	auipc	a2,0x3
ffffffffc02028de:	fee60613          	addi	a2,a2,-18 # ffffffffc02058c8 <commands+0x738>
ffffffffc02028e2:	18600593          	li	a1,390
ffffffffc02028e6:	00003517          	auipc	a0,0x3
ffffffffc02028ea:	4e250513          	addi	a0,a0,1250 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc02028ee:	b59fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc02028f2:	00003697          	auipc	a3,0x3
ffffffffc02028f6:	7de68693          	addi	a3,a3,2014 # ffffffffc02060d0 <default_pmm_manager+0x458>
ffffffffc02028fa:	00003617          	auipc	a2,0x3
ffffffffc02028fe:	fce60613          	addi	a2,a2,-50 # ffffffffc02058c8 <commands+0x738>
ffffffffc0202902:	18500593          	li	a1,389
ffffffffc0202906:	00003517          	auipc	a0,0x3
ffffffffc020290a:	4c250513          	addi	a0,a0,1218 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc020290e:	b39fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202912:	00003697          	auipc	a3,0x3
ffffffffc0202916:	78e68693          	addi	a3,a3,1934 # ffffffffc02060a0 <default_pmm_manager+0x428>
ffffffffc020291a:	00003617          	auipc	a2,0x3
ffffffffc020291e:	fae60613          	addi	a2,a2,-82 # ffffffffc02058c8 <commands+0x738>
ffffffffc0202922:	18200593          	li	a1,386
ffffffffc0202926:	00003517          	auipc	a0,0x3
ffffffffc020292a:	4a250513          	addi	a0,a0,1186 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc020292e:	b19fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202932:	00004697          	auipc	a3,0x4
ffffffffc0202936:	8c668693          	addi	a3,a3,-1850 # ffffffffc02061f8 <default_pmm_manager+0x580>
ffffffffc020293a:	00003617          	auipc	a2,0x3
ffffffffc020293e:	f8e60613          	addi	a2,a2,-114 # ffffffffc02058c8 <commands+0x738>
ffffffffc0202942:	1a600593          	li	a1,422
ffffffffc0202946:	00003517          	auipc	a0,0x3
ffffffffc020294a:	48250513          	addi	a0,a0,1154 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc020294e:	af9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202952:	00004697          	auipc	a3,0x4
ffffffffc0202956:	86e68693          	addi	a3,a3,-1938 # ffffffffc02061c0 <default_pmm_manager+0x548>
ffffffffc020295a:	00003617          	auipc	a2,0x3
ffffffffc020295e:	f6e60613          	addi	a2,a2,-146 # ffffffffc02058c8 <commands+0x738>
ffffffffc0202962:	1a500593          	li	a1,421
ffffffffc0202966:	00003517          	auipc	a0,0x3
ffffffffc020296a:	46250513          	addi	a0,a0,1122 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc020296e:	ad9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc0202972:	00004697          	auipc	a3,0x4
ffffffffc0202976:	83668693          	addi	a3,a3,-1994 # ffffffffc02061a8 <default_pmm_manager+0x530>
ffffffffc020297a:	00003617          	auipc	a2,0x3
ffffffffc020297e:	f4e60613          	addi	a2,a2,-178 # ffffffffc02058c8 <commands+0x738>
ffffffffc0202982:	1a100593          	li	a1,417
ffffffffc0202986:	00003517          	auipc	a0,0x3
ffffffffc020298a:	44250513          	addi	a0,a0,1090 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc020298e:	ab9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0202992:	00003697          	auipc	a3,0x3
ffffffffc0202996:	77e68693          	addi	a3,a3,1918 # ffffffffc0206110 <default_pmm_manager+0x498>
ffffffffc020299a:	00003617          	auipc	a2,0x3
ffffffffc020299e:	f2e60613          	addi	a2,a2,-210 # ffffffffc02058c8 <commands+0x738>
ffffffffc02029a2:	19000593          	li	a1,400
ffffffffc02029a6:	00003517          	auipc	a0,0x3
ffffffffc02029aa:	42250513          	addi	a0,a0,1058 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc02029ae:	a99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02029b2:	00003697          	auipc	a3,0x3
ffffffffc02029b6:	59668693          	addi	a3,a3,1430 # ffffffffc0205f48 <default_pmm_manager+0x2d0>
ffffffffc02029ba:	00003617          	auipc	a2,0x3
ffffffffc02029be:	f0e60613          	addi	a2,a2,-242 # ffffffffc02058c8 <commands+0x738>
ffffffffc02029c2:	16a00593          	li	a1,362
ffffffffc02029c6:	00003517          	auipc	a0,0x3
ffffffffc02029ca:	40250513          	addi	a0,a0,1026 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc02029ce:	a79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc02029d2:	00003617          	auipc	a2,0x3
ffffffffc02029d6:	2de60613          	addi	a2,a2,734 # ffffffffc0205cb0 <default_pmm_manager+0x38>
ffffffffc02029da:	16d00593          	li	a1,365
ffffffffc02029de:	00003517          	auipc	a0,0x3
ffffffffc02029e2:	3ea50513          	addi	a0,a0,1002 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc02029e6:	a61fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02029ea:	00003697          	auipc	a3,0x3
ffffffffc02029ee:	57668693          	addi	a3,a3,1398 # ffffffffc0205f60 <default_pmm_manager+0x2e8>
ffffffffc02029f2:	00003617          	auipc	a2,0x3
ffffffffc02029f6:	ed660613          	addi	a2,a2,-298 # ffffffffc02058c8 <commands+0x738>
ffffffffc02029fa:	16b00593          	li	a1,363
ffffffffc02029fe:	00003517          	auipc	a0,0x3
ffffffffc0202a02:	3ca50513          	addi	a0,a0,970 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc0202a06:	a41fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202a0a:	00003697          	auipc	a3,0x3
ffffffffc0202a0e:	5ce68693          	addi	a3,a3,1486 # ffffffffc0205fd8 <default_pmm_manager+0x360>
ffffffffc0202a12:	00003617          	auipc	a2,0x3
ffffffffc0202a16:	eb660613          	addi	a2,a2,-330 # ffffffffc02058c8 <commands+0x738>
ffffffffc0202a1a:	17300593          	li	a1,371
ffffffffc0202a1e:	00003517          	auipc	a0,0x3
ffffffffc0202a22:	3aa50513          	addi	a0,a0,938 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc0202a26:	a21fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a2a:	00004697          	auipc	a3,0x4
ffffffffc0202a2e:	88e68693          	addi	a3,a3,-1906 # ffffffffc02062b8 <default_pmm_manager+0x640>
ffffffffc0202a32:	00003617          	auipc	a2,0x3
ffffffffc0202a36:	e9660613          	addi	a2,a2,-362 # ffffffffc02058c8 <commands+0x738>
ffffffffc0202a3a:	1af00593          	li	a1,431
ffffffffc0202a3e:	00003517          	auipc	a0,0x3
ffffffffc0202a42:	38a50513          	addi	a0,a0,906 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc0202a46:	a01fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202a4a:	00004697          	auipc	a3,0x4
ffffffffc0202a4e:	83668693          	addi	a3,a3,-1994 # ffffffffc0206280 <default_pmm_manager+0x608>
ffffffffc0202a52:	00003617          	auipc	a2,0x3
ffffffffc0202a56:	e7660613          	addi	a2,a2,-394 # ffffffffc02058c8 <commands+0x738>
ffffffffc0202a5a:	1ac00593          	li	a1,428
ffffffffc0202a5e:	00003517          	auipc	a0,0x3
ffffffffc0202a62:	36a50513          	addi	a0,a0,874 # ffffffffc0205dc8 <default_pmm_manager+0x150>
ffffffffc0202a66:	9e1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 2);
ffffffffc0202a6a:	00003697          	auipc	a3,0x3
ffffffffc0202a6e:	7e668693          	addi	a3,a3,2022 # ffffffffc0206250 <default_pmm_manager+0x5d8>
ffffffffc0202a72:	00003617          	auipc	a2,0x3
ffffffffc0202a76:	e5660613          	addi	a2,a2,-426 # ffffffffc02058c8 <commands+0x738>
ffffffffc0202a7a:	1a800593          	li	a1,424
ffffffffc0202a7e:	00003517          	auipc	a0,0x3
ffffffffc0202a82:	34a50513          	addi	a0,a0,842 # ffffffffc0205dc8 <default_pmm_manager+0x150>
...
ffffffffc0202af4:	81068693          	addi	a3,a3,-2032 # ffffffffc0206300 <default_pmm_manager+0x688>
ffffffffc0202af8:	00003617          	auipc	a2,0x3
ffffffffc0202afc:	dd060613          	addi	a2,a2,-560 # ffffffffc02058c8 <commands+0x738>
ffffffffc0202b00:	14800593          	li	a1,328
ffffffffc0202b04:	00003517          	auipc	a0,0x3
ffffffffc0202b08:	2c450513          	addi	a0,a0,708 # ffffffffc0205dc8 <default_pmm_manager+0x150>
...
ffffffffc0202b4e:	23660613          	addi	a2,a2,566 # ffffffffc0205d80 <default_pmm_manager+0x108>
ffffffffc0202b52:	06300593          	li	a1,99
ffffffffc0202b56:	00003517          	auipc	a0,0x3
ffffffffc0202b5a:	18250513          	addi	a0,a0,386 # ffffffffc0205cd8 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0202bde:	76e50513          	addi	a0,a0,1902 # ffffffffc0206348 <default_pmm_manager+0x6d0>
    return listelm->next;
...
ffffffffc0202c30:	73450513          	addi	a0,a0,1844 # ffffffffc0206360 <default_pmm_manager+0x6e8>
...
ffffffffc0202c84:	75050513          	addi	a0,a0,1872 # ffffffffc02063d0 <default_pmm_manager+0x758>
...
ffffffffc0202ca0:	78450513          	addi	a0,a0,1924 # ffffffffc0206420 <default_pmm_manager+0x7a8>
...
ffffffffc0202d14:	79850513          	addi	a0,a0,1944 # ffffffffc02064a8 <default_pmm_manager+0x830>
...
ffffffffc0202e2c:	1e060613          	addi	a2,a2,480 # ffffffffc0207008 <nbase>
...
ffffffffc0202e58:	6fc50513          	addi	a0,a0,1788 # ffffffffc0206550 <default_pmm_manager+0x8d8>
...
ffffffffc0202f2c:	67850513          	addi	a0,a0,1656 # ffffffffc02065a0 <default_pmm_manager+0x928>
...
ffffffffc0202f3e:	97e68693          	addi	a3,a3,-1666 # ffffffffc02058b8 <commands+0x728>
ffffffffc0202f42:	00003617          	auipc	a2,0x3
ffffffffc0202f46:	98660613          	addi	a2,a2,-1658 # ffffffffc02058c8 <commands+0x738>
ffffffffc0202f4a:	0bd00593          	li	a1,189
ffffffffc0202f4e:	00003517          	auipc	a0,0x3
ffffffffc0202f52:	3ea50513          	addi	a0,a0,1002 # ffffffffc0206338 <default_pmm_manager+0x6c0>
...
ffffffffc0202f62:	e2260613          	addi	a2,a2,-478 # ffffffffc0205d80 <default_pmm_manager+0x108>
ffffffffc0202f66:	06300593          	li	a1,99
ffffffffc0202f6a:	00003517          	auipc	a0,0x3
ffffffffc0202f6e:	d6e50513          	addi	a0,a0,-658 # ffffffffc0205cd8 <default_pmm_manager+0x60>
ffffffffc0202f72:	cd4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202f76:	00003697          	auipc	a3,0x3
ffffffffc0202f7a:	5b268693          	addi	a3,a3,1458 # ffffffffc0206528 <default_pmm_manager+0x8b0>
ffffffffc0202f7e:	00003617          	auipc	a2,0x3
ffffffffc0202f82:	94a60613          	addi	a2,a2,-1718 # ffffffffc02058c8 <commands+0x738>
ffffffffc0202f86:	0fd00593          	li	a1,253
ffffffffc0202f8a:	00003517          	auipc	a0,0x3
ffffffffc0202f8e:	3ae50513          	addi	a0,a0,942 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc0202f92:	cb4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202f96:	00003697          	auipc	a3,0x3
ffffffffc0202f9a:	4b268693          	addi	a3,a3,1202 # ffffffffc0206448 <default_pmm_manager+0x7d0>
ffffffffc0202f9e:	00003617          	auipc	a2,0x3
ffffffffc0202fa2:	92a60613          	addi	a2,a2,-1750 # ffffffffc02058c8 <commands+0x738>
ffffffffc0202fa6:	0dd00593          	li	a1,221
ffffffffc0202faa:	00003517          	auipc	a0,0x3
ffffffffc0202fae:	38e50513          	addi	a0,a0,910 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc0202fb2:	c94fd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202fb6:	00003617          	auipc	a2,0x3
ffffffffc0202fba:	36260613          	addi	a2,a2,866 # ffffffffc0206318 <default_pmm_manager+0x6a0>
ffffffffc0202fbe:	02a00593          	li	a1,42
ffffffffc0202fc2:	00003517          	auipc	a0,0x3
ffffffffc0202fc6:	37650513          	addi	a0,a0,886 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc0202fca:	c7cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202fce:	00003697          	auipc	a3,0x3
ffffffffc0202fd2:	54268693          	addi	a3,a3,1346 # ffffffffc0206510 <default_pmm_manager+0x898>
ffffffffc0202fd6:	00003617          	auipc	a2,0x3
ffffffffc0202fda:	8f260613          	addi	a2,a2,-1806 # ffffffffc02058c8 <commands+0x738>
ffffffffc0202fde:	0fc00593          	li	a1,252
ffffffffc0202fe2:	00003517          	auipc	a0,0x3
ffffffffc0202fe6:	35650513          	addi	a0,a0,854 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc0202fea:	c5cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202fee:	00003617          	auipc	a2,0x3
ffffffffc0202ff2:	db260613          	addi	a2,a2,-590 # ffffffffc0205da0 <default_pmm_manager+0x128>
ffffffffc0202ff6:	07500593          	li	a1,117
ffffffffc0202ffa:	00003517          	auipc	a0,0x3
ffffffffc0202ffe:	cde50513          	addi	a0,a0,-802 # ffffffffc0205cd8 <default_pmm_manager+0x60>
ffffffffc0203002:	c44fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0203006:	00003697          	auipc	a3,0x3
ffffffffc020300a:	45a68693          	addi	a3,a3,1114 # ffffffffc0206460 <default_pmm_manager+0x7e8>
ffffffffc020300e:	00003617          	auipc	a2,0x3
ffffffffc0203012:	8ba60613          	addi	a2,a2,-1862 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203016:	0de00593          	li	a1,222
ffffffffc020301a:	00003517          	auipc	a0,0x3
ffffffffc020301e:	31e50513          	addi	a0,a0,798 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc0203022:	c24fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0203026:	00003697          	auipc	a3,0x3
ffffffffc020302a:	37268693          	addi	a3,a3,882 # ffffffffc0206398 <default_pmm_manager+0x720>
ffffffffc020302e:	00003617          	auipc	a2,0x3
ffffffffc0203032:	89a60613          	addi	a2,a2,-1894 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203036:	0c800593          	li	a1,200
ffffffffc020303a:	00003517          	auipc	a0,0x3
ffffffffc020303e:	2fe50513          	addi	a0,a0,766 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc0203042:	c04fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total == nr_free_pages());
ffffffffc0203046:	00003697          	auipc	a3,0x3
ffffffffc020304a:	8b268693          	addi	a3,a3,-1870 # ffffffffc02058f8 <commands+0x768>
ffffffffc020304e:	00003617          	auipc	a2,0x3
ffffffffc0203052:	87a60613          	addi	a2,a2,-1926 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203056:	0c000593          	li	a1,192
ffffffffc020305a:	00003517          	auipc	a0,0x3
ffffffffc020305e:	2de50513          	addi	a0,a0,734 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc0203062:	be4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert( nr_free == 0);         
ffffffffc0203066:	00003697          	auipc	a3,0x3
ffffffffc020306a:	a3a68693          	addi	a3,a3,-1478 # ffffffffc0205aa0 <commands+0x910>
ffffffffc020306e:	00003617          	auipc	a2,0x3
ffffffffc0203072:	85a60613          	addi	a2,a2,-1958 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203076:	0f400593          	li	a1,244
ffffffffc020307a:	00003517          	auipc	a0,0x3
ffffffffc020307e:	2be50513          	addi	a0,a0,702 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc0203082:	bc4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0203086:	00003697          	auipc	a3,0x3
ffffffffc020308a:	32a68693          	addi	a3,a3,810 # ffffffffc02063b0 <default_pmm_manager+0x738>
ffffffffc020308e:	00003617          	auipc	a2,0x3
ffffffffc0203092:	83a60613          	addi	a2,a2,-1990 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203096:	0cd00593          	li	a1,205
ffffffffc020309a:	00003517          	auipc	a0,0x3
ffffffffc020309e:	29e50513          	addi	a0,a0,670 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc02030a2:	ba4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(mm != NULL);
ffffffffc02030a6:	00003697          	auipc	a3,0x3
ffffffffc02030aa:	2e268693          	addi	a3,a3,738 # ffffffffc0206388 <default_pmm_manager+0x710>
ffffffffc02030ae:	00003617          	auipc	a2,0x3
ffffffffc02030b2:	81a60613          	addi	a2,a2,-2022 # ffffffffc02058c8 <commands+0x738>
ffffffffc02030b6:	0c500593          	li	a1,197
ffffffffc02030ba:	00003517          	auipc	a0,0x3
ffffffffc02030be:	27e50513          	addi	a0,a0,638 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc02030c2:	b84fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total==0);
ffffffffc02030c6:	00003697          	auipc	a3,0x3
ffffffffc02030ca:	4ca68693          	addi	a3,a3,1226 # ffffffffc0206590 <default_pmm_manager+0x918>
ffffffffc02030ce:	00002617          	auipc	a2,0x2
ffffffffc02030d2:	7fa60613          	addi	a2,a2,2042 # ffffffffc02058c8 <commands+0x738>
ffffffffc02030d6:	11d00593          	li	a1,285
ffffffffc02030da:	00003517          	auipc	a0,0x3
ffffffffc02030de:	25e50513          	addi	a0,a0,606 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc02030e2:	b64fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc02030e6:	00003617          	auipc	a2,0x3
ffffffffc02030ea:	bca60613          	addi	a2,a2,-1078 # ffffffffc0205cb0 <default_pmm_manager+0x38>
ffffffffc02030ee:	06a00593          	li	a1,106
ffffffffc02030f2:	00003517          	auipc	a0,0x3
ffffffffc02030f6:	be650513          	addi	a0,a0,-1050 # ffffffffc0205cd8 <default_pmm_manager+0x60>
ffffffffc02030fa:	b4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(count==0);
ffffffffc02030fe:	00003697          	auipc	a3,0x3
ffffffffc0203102:	48268693          	addi	a3,a3,1154 # ffffffffc0206580 <default_pmm_manager+0x908>
ffffffffc0203106:	00002617          	auipc	a2,0x2
ffffffffc020310a:	7c260613          	addi	a2,a2,1986 # ffffffffc02058c8 <commands+0x738>
ffffffffc020310e:	11c00593          	li	a1,284
ffffffffc0203112:	00003517          	auipc	a0,0x3
ffffffffc0203116:	22650513          	addi	a0,a0,550 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc020311a:	b2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020311e:	00003697          	auipc	a3,0x3
ffffffffc0203122:	3b268693          	addi	a3,a3,946 # ffffffffc02064d0 <default_pmm_manager+0x858>
ffffffffc0203126:	00002617          	auipc	a2,0x2
ffffffffc020312a:	7a260613          	addi	a2,a2,1954 # ffffffffc02058c8 <commands+0x738>
ffffffffc020312e:	09600593          	li	a1,150
ffffffffc0203132:	00003517          	auipc	a0,0x3
ffffffffc0203136:	20650513          	addi	a0,a0,518 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc020313a:	b0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc020313e:	00003697          	auipc	a3,0x3
ffffffffc0203142:	34268693          	addi	a3,a3,834 # ffffffffc0206480 <default_pmm_manager+0x808>
ffffffffc0203146:	00002617          	auipc	a2,0x2
ffffffffc020314a:	78260613          	addi	a2,a2,1922 # ffffffffc02058c8 <commands+0x738>
ffffffffc020314e:	0eb00593          	li	a1,235
ffffffffc0203152:	00003517          	auipc	a0,0x3
ffffffffc0203156:	1e650513          	addi	a0,a0,486 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc020315a:	aecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc020315e:	00003697          	auipc	a3,0x3
ffffffffc0203162:	2aa68693          	addi	a3,a3,682 # ffffffffc0206408 <default_pmm_manager+0x790>
ffffffffc0203166:	00002617          	auipc	a2,0x2
ffffffffc020316a:	76260613          	addi	a2,a2,1890 # ffffffffc02058c8 <commands+0x738>
ffffffffc020316e:	0d800593          	li	a1,216
ffffffffc0203172:	00003517          	auipc	a0,0x3
ffffffffc0203176:	1c650513          	addi	a0,a0,454 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc020317a:	accfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(ret==0);
ffffffffc020317e:	00003697          	auipc	a3,0x3
ffffffffc0203182:	3fa68693          	addi	a3,a3,1018 # ffffffffc0206578 <default_pmm_manager+0x900>
ffffffffc0203186:	00002617          	auipc	a2,0x2
ffffffffc020318a:	74260613          	addi	a2,a2,1858 # ffffffffc02058c8 <commands+0x738>
ffffffffc020318e:	10300593          	li	a1,259
ffffffffc0203192:	00003517          	auipc	a0,0x3
ffffffffc0203196:	1a650513          	addi	a0,a0,422 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc020319a:	aacfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(vma != NULL);
ffffffffc020319e:	00003697          	auipc	a3,0x3
ffffffffc02031a2:	22268693          	addi	a3,a3,546 # ffffffffc02063c0 <default_pmm_manager+0x748>
ffffffffc02031a6:	00002617          	auipc	a2,0x2
ffffffffc02031aa:	72260613          	addi	a2,a2,1826 # ffffffffc02058c8 <commands+0x738>
ffffffffc02031ae:	0d000593          	li	a1,208
ffffffffc02031b2:	00003517          	auipc	a0,0x3
ffffffffc02031b6:	18650513          	addi	a0,a0,390 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc02031ba:	a8cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031be:	00003697          	auipc	a3,0x3
ffffffffc02031c2:	34268693          	addi	a3,a3,834 # ffffffffc0206500 <default_pmm_manager+0x888>
ffffffffc02031c6:	00002617          	auipc	a2,0x2
ffffffffc02031ca:	70260613          	addi	a2,a2,1794 # ffffffffc02058c8 <commands+0x738>
ffffffffc02031ce:	0a000593          	li	a1,160
ffffffffc02031d2:	00003517          	auipc	a0,0x3
ffffffffc02031d6:	16650513          	addi	a0,a0,358 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc02031da:	a6cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031de:	00003697          	auipc	a3,0x3
ffffffffc02031e2:	32268693          	addi	a3,a3,802 # ffffffffc0206500 <default_pmm_manager+0x888>
ffffffffc02031e6:	00002617          	auipc	a2,0x2
ffffffffc02031ea:	6e260613          	addi	a2,a2,1762 # ffffffffc02058c8 <commands+0x738>
ffffffffc02031ee:	0a200593          	li	a1,162
ffffffffc02031f2:	00003517          	auipc	a0,0x3
ffffffffc02031f6:	14650513          	addi	a0,a0,326 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc02031fa:	a4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc02031fe:	00003697          	auipc	a3,0x3
ffffffffc0203202:	2e268693          	addi	a3,a3,738 # ffffffffc02064e0 <default_pmm_manager+0x868>
ffffffffc0203206:	00002617          	auipc	a2,0x2
ffffffffc020320a:	6c260613          	addi	a2,a2,1730 # ffffffffc02058c8 <commands+0x738>
ffffffffc020320e:	09800593          	li	a1,152
ffffffffc0203212:	00003517          	auipc	a0,0x3
ffffffffc0203216:	12650513          	addi	a0,a0,294 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc020321a:	a2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc020321e:	00003697          	auipc	a3,0x3
ffffffffc0203222:	2c268693          	addi	a3,a3,706 # ffffffffc02064e0 <default_pmm_manager+0x868>
ffffffffc0203226:	00002617          	auipc	a2,0x2
ffffffffc020322a:	6a260613          	addi	a2,a2,1698 # ffffffffc02058c8 <commands+0x738>
ffffffffc020322e:	09a00593          	li	a1,154
ffffffffc0203232:	00003517          	auipc	a0,0x3
ffffffffc0203236:	10650513          	addi	a0,a0,262 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc020323a:	a0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020323e:	00003697          	auipc	a3,0x3
ffffffffc0203242:	2b268693          	addi	a3,a3,690 # ffffffffc02064f0 <default_pmm_manager+0x878>
ffffffffc0203246:	00002617          	auipc	a2,0x2
ffffffffc020324a:	68260613          	addi	a2,a2,1666 # ffffffffc02058c8 <commands+0x738>
ffffffffc020324e:	09c00593          	li	a1,156
ffffffffc0203252:	00003517          	auipc	a0,0x3
ffffffffc0203256:	0e650513          	addi	a0,a0,230 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc020325a:	9ecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020325e:	00003697          	auipc	a3,0x3
ffffffffc0203262:	29268693          	addi	a3,a3,658 # ffffffffc02064f0 <default_pmm_manager+0x878>
ffffffffc0203266:	00002617          	auipc	a2,0x2
ffffffffc020326a:	66260613          	addi	a2,a2,1634 # ffffffffc02058c8 <commands+0x738>
ffffffffc020326e:	09e00593          	li	a1,158
ffffffffc0203272:	00003517          	auipc	a0,0x3
ffffffffc0203276:	0c650513          	addi	a0,a0,198 # ffffffffc0206338 <default_pmm_manager+0x6c0>
ffffffffc020327a:	9ccfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020327e:	00003697          	auipc	a3,0x3
ffffffffc0203282:	25268693          	addi	a3,a3,594 # ffffffffc02064d0 <default_pmm_manager+0x858>
ffffffffc0203286:	00002617          	auipc	a2,0x2
ffffffffc020328a:	64260613          	addi	a2,a2,1602 # ffffffffc02058c8 <commands+0x738>
ffffffffc020328e:	09400593          	li	a1,148
ffffffffc0203292:	00003517          	auipc	a0,0x3
ffffffffc0203296:	0a650513          	addi	a0,a0,166 # ffffffffc0206338 <default_pmm_manager+0x6c0>
...
ffffffffc02032e2:	342b0b13          	addi	s6,s6,834 # ffffffffc0206620 <default_pmm_manager+0x9a8>
                    cprintf("SWAP: failed to save\n");
ffffffffc02032e6:	00003b97          	auipc	s7,0x3
ffffffffc02032ea:	322b8b93          	addi	s7,s7,802 # ffffffffc0206608 <default_pmm_manager+0x990>
...
ffffffffc020339c:	22850513          	addi	a0,a0,552 # ffffffffc02065c0 <default_pmm_manager+0x948>
...
ffffffffc02033ae:	24668693          	addi	a3,a3,582 # ffffffffc02065f0 <default_pmm_manager+0x978>
ffffffffc02033b2:	00002617          	auipc	a2,0x2
ffffffffc02033b6:	51660613          	addi	a2,a2,1302 # ffffffffc02058c8 <commands+0x738>
ffffffffc02033ba:	06900593          	li	a1,105
ffffffffc02033be:	00003517          	auipc	a0,0x3
ffffffffc02033c2:	f7a50513          	addi	a0,a0,-134 # ffffffffc0206338 <default_pmm_manager+0x6c0>
...
ffffffffc0203406:	26e50513          	addi	a0,a0,622 # ffffffffc0206670 <default_pmm_manager+0x9f8>
...
ffffffffc0203428:	23c68693          	addi	a3,a3,572 # ffffffffc0206660 <default_pmm_manager+0x9e8>
ffffffffc020342c:	00002617          	auipc	a2,0x2
ffffffffc0203430:	49c60613          	addi	a2,a2,1180 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203434:	07f00593          	li	a1,127
ffffffffc0203438:	00003517          	auipc	a0,0x3
ffffffffc020343c:	f0050513          	addi	a0,a0,-256 # ffffffffc0206338 <default_pmm_manager+0x6c0>
...
ffffffffc020346c:	24850513          	addi	a0,a0,584 # ffffffffc02066b0 <default_pmm_manager+0xa38>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc02034a2:	25250513          	addi	a0,a0,594 # ffffffffc02066f0 <default_pmm_manager+0xa78>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02034c6:	25650513          	addi	a0,a0,598 # ffffffffc0206718 <default_pmm_manager+0xaa0>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc02034e4:	26050513          	addi	a0,a0,608 # ffffffffc0206740 <default_pmm_manager+0xac8>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc0203500:	26c50513          	addi	a0,a0,620 # ffffffffc0206768 <default_pmm_manager+0xaf0>
...
ffffffffc020351e:	22650513          	addi	a0,a0,550 # ffffffffc0206740 <default_pmm_manager+0xac8>
...
ffffffffc0203536:	1be50513          	addi	a0,a0,446 # ffffffffc02066f0 <default_pmm_manager+0xa78>
...
ffffffffc0203550:	1f450513          	addi	a0,a0,500 # ffffffffc0206740 <default_pmm_manager+0xac8>
...
ffffffffc020356a:	14a50513          	addi	a0,a0,330 # ffffffffc02066b0 <default_pmm_manager+0xa38>
...
ffffffffc0203584:	19850513          	addi	a0,a0,408 # ffffffffc0206718 <default_pmm_manager+0xaa0>
...
ffffffffc020359e:	1ce50513          	addi	a0,a0,462 # ffffffffc0206768 <default_pmm_manager+0xaf0>
...
ffffffffc02035bc:	13850513          	addi	a0,a0,312 # ffffffffc02066f0 <default_pmm_manager+0xa78>
...
ffffffffc02035fa:	f0a68693          	addi	a3,a3,-246 # ffffffffc0206500 <default_pmm_manager+0x888>
ffffffffc02035fe:	00002617          	auipc	a2,0x2
ffffffffc0203602:	2ca60613          	addi	a2,a2,714 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203606:	05100593          	li	a1,81
ffffffffc020360a:	00003517          	auipc	a0,0x3
ffffffffc020360e:	0ce50513          	addi	a0,a0,206 # ffffffffc02066d8 <default_pmm_manager+0xa60>
ffffffffc0203612:	e35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==11);
ffffffffc0203616:	00003697          	auipc	a3,0x3
ffffffffc020361a:	20268693          	addi	a3,a3,514 # ffffffffc0206818 <default_pmm_manager+0xba0>
ffffffffc020361e:	00002617          	auipc	a2,0x2
ffffffffc0203622:	2aa60613          	addi	a2,a2,682 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203626:	07300593          	li	a1,115
ffffffffc020362a:	00003517          	auipc	a0,0x3
ffffffffc020362e:	0ae50513          	addi	a0,a0,174 # ffffffffc02066d8 <default_pmm_manager+0xa60>
ffffffffc0203632:	e15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203636:	00003697          	auipc	a3,0x3
ffffffffc020363a:	1ba68693          	addi	a3,a3,442 # ffffffffc02067f0 <default_pmm_manager+0xb78>
ffffffffc020363e:	00002617          	auipc	a2,0x2
ffffffffc0203642:	28a60613          	addi	a2,a2,650 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203646:	07100593          	li	a1,113
ffffffffc020364a:	00003517          	auipc	a0,0x3
ffffffffc020364e:	08e50513          	addi	a0,a0,142 # ffffffffc02066d8 <default_pmm_manager+0xa60>
ffffffffc0203652:	df5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==10);
ffffffffc0203656:	00003697          	auipc	a3,0x3
ffffffffc020365a:	18a68693          	addi	a3,a3,394 # ffffffffc02067e0 <default_pmm_manager+0xb68>
ffffffffc020365e:	00002617          	auipc	a2,0x2
ffffffffc0203662:	26a60613          	addi	a2,a2,618 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203666:	06f00593          	li	a1,111
ffffffffc020366a:	00003517          	auipc	a0,0x3
ffffffffc020366e:	06e50513          	addi	a0,a0,110 # ffffffffc02066d8 <default_pmm_manager+0xa60>
ffffffffc0203672:	dd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==9);
ffffffffc0203676:	00003697          	auipc	a3,0x3
ffffffffc020367a:	15a68693          	addi	a3,a3,346 # ffffffffc02067d0 <default_pmm_manager+0xb58>
ffffffffc020367e:	00002617          	auipc	a2,0x2
ffffffffc0203682:	24a60613          	addi	a2,a2,586 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203686:	06c00593          	li	a1,108
ffffffffc020368a:	00003517          	auipc	a0,0x3
ffffffffc020368e:	04e50513          	addi	a0,a0,78 # ffffffffc02066d8 <default_pmm_manager+0xa60>
ffffffffc0203692:	db5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==8);
ffffffffc0203696:	00003697          	auipc	a3,0x3
ffffffffc020369a:	12a68693          	addi	a3,a3,298 # ffffffffc02067c0 <default_pmm_manager+0xb48>
ffffffffc020369e:	00002617          	auipc	a2,0x2
ffffffffc02036a2:	22a60613          	addi	a2,a2,554 # ffffffffc02058c8 <commands+0x738>
ffffffffc02036a6:	06900593          	li	a1,105
ffffffffc02036aa:	00003517          	auipc	a0,0x3
ffffffffc02036ae:	02e50513          	addi	a0,a0,46 # ffffffffc02066d8 <default_pmm_manager+0xa60>
ffffffffc02036b2:	d95fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==7);
ffffffffc02036b6:	00003697          	auipc	a3,0x3
ffffffffc02036ba:	0fa68693          	addi	a3,a3,250 # ffffffffc02067b0 <default_pmm_manager+0xb38>
ffffffffc02036be:	00002617          	auipc	a2,0x2
ffffffffc02036c2:	20a60613          	addi	a2,a2,522 # ffffffffc02058c8 <commands+0x738>
ffffffffc02036c6:	06600593          	li	a1,102
ffffffffc02036ca:	00003517          	auipc	a0,0x3
ffffffffc02036ce:	00e50513          	addi	a0,a0,14 # ffffffffc02066d8 <default_pmm_manager+0xa60>
ffffffffc02036d2:	d75fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==6);
ffffffffc02036d6:	00003697          	auipc	a3,0x3
ffffffffc02036da:	0ca68693          	addi	a3,a3,202 # ffffffffc02067a0 <default_pmm_manager+0xb28>
ffffffffc02036de:	00002617          	auipc	a2,0x2
ffffffffc02036e2:	1ea60613          	addi	a2,a2,490 # ffffffffc02058c8 <commands+0x738>
ffffffffc02036e6:	06300593          	li	a1,99
ffffffffc02036ea:	00003517          	auipc	a0,0x3
ffffffffc02036ee:	fee50513          	addi	a0,a0,-18 # ffffffffc02066d8 <default_pmm_manager+0xa60>
ffffffffc02036f2:	d55fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc02036f6:	00003697          	auipc	a3,0x3
ffffffffc02036fa:	09a68693          	addi	a3,a3,154 # ffffffffc0206790 <default_pmm_manager+0xb18>
ffffffffc02036fe:	00002617          	auipc	a2,0x2
ffffffffc0203702:	1ca60613          	addi	a2,a2,458 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203706:	06000593          	li	a1,96
ffffffffc020370a:	00003517          	auipc	a0,0x3
ffffffffc020370e:	fce50513          	addi	a0,a0,-50 # ffffffffc02066d8 <default_pmm_manager+0xa60>
ffffffffc0203712:	d35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc0203716:	00003697          	auipc	a3,0x3
ffffffffc020371a:	07a68693          	addi	a3,a3,122 # ffffffffc0206790 <default_pmm_manager+0xb18>
ffffffffc020371e:	00002617          	auipc	a2,0x2
ffffffffc0203722:	1aa60613          	addi	a2,a2,426 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203726:	05d00593          	li	a1,93
ffffffffc020372a:	00003517          	auipc	a0,0x3
ffffffffc020372e:	fae50513          	addi	a0,a0,-82 # ffffffffc02066d8 <default_pmm_manager+0xa60>
ffffffffc0203732:	d15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203736:	00003697          	auipc	a3,0x3
ffffffffc020373a:	dca68693          	addi	a3,a3,-566 # ffffffffc0206500 <default_pmm_manager+0x888>
ffffffffc020373e:	00002617          	auipc	a2,0x2
ffffffffc0203742:	18a60613          	addi	a2,a2,394 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203746:	05a00593          	li	a1,90
ffffffffc020374a:	00003517          	auipc	a0,0x3
ffffffffc020374e:	f8e50513          	addi	a0,a0,-114 # ffffffffc02066d8 <default_pmm_manager+0xa60>
ffffffffc0203752:	cf5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203756:	00003697          	auipc	a3,0x3
ffffffffc020375a:	daa68693          	addi	a3,a3,-598 # ffffffffc0206500 <default_pmm_manager+0x888>
ffffffffc020375e:	00002617          	auipc	a2,0x2
ffffffffc0203762:	16a60613          	addi	a2,a2,362 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203766:	05700593          	li	a1,87
ffffffffc020376a:	00003517          	auipc	a0,0x3
ffffffffc020376e:	f6e50513          	addi	a0,a0,-146 # ffffffffc02066d8 <default_pmm_manager+0xa60>
ffffffffc0203772:	cd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203776:	00003697          	auipc	a3,0x3
ffffffffc020377a:	d8a68693          	addi	a3,a3,-630 # ffffffffc0206500 <default_pmm_manager+0x888>
ffffffffc020377e:	00002617          	auipc	a2,0x2
ffffffffc0203782:	14a60613          	addi	a2,a2,330 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203786:	05400593          	li	a1,84
ffffffffc020378a:	00003517          	auipc	a0,0x3
ffffffffc020378e:	f4e50513          	addi	a0,a0,-178 # ffffffffc02066d8 <default_pmm_manager+0xa60>
...
ffffffffc02037bc:	07068693          	addi	a3,a3,112 # ffffffffc0206828 <default_pmm_manager+0xbb0>
ffffffffc02037c0:	00002617          	auipc	a2,0x2
ffffffffc02037c4:	10860613          	addi	a2,a2,264 # ffffffffc02058c8 <commands+0x738>
ffffffffc02037c8:	04100593          	li	a1,65
ffffffffc02037cc:	00003517          	auipc	a0,0x3
ffffffffc02037d0:	f0c50513          	addi	a0,a0,-244 # ffffffffc02066d8 <default_pmm_manager+0xa60>
ffffffffc02037d4:	c73fc0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(in_tick==0);
ffffffffc02037d8:	00003697          	auipc	a3,0x3
ffffffffc02037dc:	06068693          	addi	a3,a3,96 # ffffffffc0206838 <default_pmm_manager+0xbc0>
ffffffffc02037e0:	00002617          	auipc	a2,0x2
ffffffffc02037e4:	0e860613          	addi	a2,a2,232 # ffffffffc02058c8 <commands+0x738>
ffffffffc02037e8:	04200593          	li	a1,66
ffffffffc02037ec:	00003517          	auipc	a0,0x3
ffffffffc02037f0:	eec50513          	addi	a0,a0,-276 # ffffffffc02066d8 <default_pmm_manager+0xa60>
...
ffffffffc0203814:	03868693          	addi	a3,a3,56 # ffffffffc0206848 <default_pmm_manager+0xbd0>
ffffffffc0203818:	00002617          	auipc	a2,0x2
ffffffffc020381c:	0b060613          	addi	a2,a2,176 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203820:	03200593          	li	a1,50
ffffffffc0203824:	00003517          	auipc	a0,0x3
ffffffffc0203828:	eb450513          	addi	a0,a0,-332 # ffffffffc02066d8 <default_pmm_manager+0xa60>
{
...
ffffffffc0203838:	04c68693          	addi	a3,a3,76 # ffffffffc0206880 <default_pmm_manager+0xc08>
ffffffffc020383c:	00002617          	auipc	a2,0x2
ffffffffc0203840:	08c60613          	addi	a2,a2,140 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203844:	07e00593          	li	a1,126
ffffffffc0203848:	00003517          	auipc	a0,0x3
ffffffffc020384c:	05850513          	addi	a0,a0,88 # ffffffffc02068a0 <default_pmm_manager+0xc28>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc0203980:	f3468693          	addi	a3,a3,-204 # ffffffffc02068b0 <default_pmm_manager+0xc38>
ffffffffc0203984:	00002617          	auipc	a2,0x2
ffffffffc0203988:	f4460613          	addi	a2,a2,-188 # ffffffffc02058c8 <commands+0x738>
ffffffffc020398c:	08500593          	li	a1,133
ffffffffc0203990:	00003517          	auipc	a0,0x3
ffffffffc0203994:	f1050513          	addi	a0,a0,-240 # ffffffffc02068a0 <default_pmm_manager+0xc28>
ffffffffc0203998:	aaffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020399c:	00003697          	auipc	a3,0x3
ffffffffc02039a0:	f5468693          	addi	a3,a3,-172 # ffffffffc02068f0 <default_pmm_manager+0xc78>
ffffffffc02039a4:	00002617          	auipc	a2,0x2
ffffffffc02039a8:	f2460613          	addi	a2,a2,-220 # ffffffffc02058c8 <commands+0x738>
ffffffffc02039ac:	07d00593          	li	a1,125
ffffffffc02039b0:	00003517          	auipc	a0,0x3
ffffffffc02039b4:	ef050513          	addi	a0,a0,-272 # ffffffffc02068a0 <default_pmm_manager+0xc28>
ffffffffc02039b8:	a8ffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02039bc:	00003697          	auipc	a3,0x3
ffffffffc02039c0:	f1468693          	addi	a3,a3,-236 # ffffffffc02068d0 <default_pmm_manager+0xc58>
ffffffffc02039c4:	00002617          	auipc	a2,0x2
ffffffffc02039c8:	f0460613          	addi	a2,a2,-252 # ffffffffc02058c8 <commands+0x738>
ffffffffc02039cc:	07c00593          	li	a1,124
ffffffffc02039d0:	00003517          	auipc	a0,0x3
ffffffffc02039d4:	ed050513          	addi	a0,a0,-304 # ffffffffc02068a0 <default_pmm_manager+0xc28>
...
ffffffffc0203a72:	95268693          	addi	a3,a3,-1710 # ffffffffc02063c0 <default_pmm_manager+0x748>
ffffffffc0203a76:	00002617          	auipc	a2,0x2
ffffffffc0203a7a:	e5260613          	addi	a2,a2,-430 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203a7e:	0c900593          	li	a1,201
ffffffffc0203a82:	00003517          	auipc	a0,0x3
ffffffffc0203a86:	e1e50513          	addi	a0,a0,-482 # ffffffffc02068a0 <default_pmm_manager+0xc28>
...
ffffffffc0203ac6:	8fe68693          	addi	a3,a3,-1794 # ffffffffc02063c0 <default_pmm_manager+0x748>
ffffffffc0203aca:	00002617          	auipc	a2,0x2
ffffffffc0203ace:	dfe60613          	addi	a2,a2,-514 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203ad2:	0cf00593          	li	a1,207
ffffffffc0203ad6:	00003517          	auipc	a0,0x3
ffffffffc0203ada:	dca50513          	addi	a0,a0,-566 # ffffffffc02068a0 <default_pmm_manager+0xc28>
...
ffffffffc0203b9a:	e7a50513          	addi	a0,a0,-390 # ffffffffc0206a10 <default_pmm_manager+0xd98>
ffffffffc0203b9e:	de2fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203ba2:	00003697          	auipc	a3,0x3
ffffffffc0203ba6:	e9668693          	addi	a3,a3,-362 # ffffffffc0206a38 <default_pmm_manager+0xdc0>
ffffffffc0203baa:	00002617          	auipc	a2,0x2
ffffffffc0203bae:	d1e60613          	addi	a2,a2,-738 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203bb2:	0f100593          	li	a1,241
ffffffffc0203bb6:	00003517          	auipc	a0,0x3
ffffffffc0203bba:	cea50513          	addi	a0,a0,-790 # ffffffffc02068a0 <default_pmm_manager+0xc28>
...
ffffffffc0203be8:	e6c50513          	addi	a0,a0,-404 # ffffffffc0206a50 <default_pmm_manager+0xdd8>
...
ffffffffc0203cc2:	34aa3a03          	ld	s4,842(s4) # ffffffffc0207008 <nbase>
...
ffffffffc0203d7c:	d5050513          	addi	a0,a0,-688 # ffffffffc0206ac8 <default_pmm_manager+0xe50>
...
ffffffffc0203d96:	d5650513          	addi	a0,a0,-682 # ffffffffc0206ae8 <default_pmm_manager+0xe70>
}
...
ffffffffc0203daa:	b8268693          	addi	a3,a3,-1150 # ffffffffc0206928 <default_pmm_manager+0xcb0>
ffffffffc0203dae:	00002617          	auipc	a2,0x2
ffffffffc0203db2:	b1a60613          	addi	a2,a2,-1254 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203db6:	0d800593          	li	a1,216
ffffffffc0203dba:	00003517          	auipc	a0,0x3
ffffffffc0203dbe:	ae650513          	addi	a0,a0,-1306 # ffffffffc02068a0 <default_pmm_manager+0xc28>
ffffffffc0203dc2:	e84fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203dc6:	00003697          	auipc	a3,0x3
ffffffffc0203dca:	bea68693          	addi	a3,a3,-1046 # ffffffffc02069b0 <default_pmm_manager+0xd38>
ffffffffc0203dce:	00002617          	auipc	a2,0x2
ffffffffc0203dd2:	afa60613          	addi	a2,a2,-1286 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203dd6:	0e800593          	li	a1,232
ffffffffc0203dda:	00003517          	auipc	a0,0x3
ffffffffc0203dde:	ac650513          	addi	a0,a0,-1338 # ffffffffc02068a0 <default_pmm_manager+0xc28>
ffffffffc0203de2:	e64fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203de6:	00003697          	auipc	a3,0x3
ffffffffc0203dea:	bfa68693          	addi	a3,a3,-1030 # ffffffffc02069e0 <default_pmm_manager+0xd68>
ffffffffc0203dee:	00002617          	auipc	a2,0x2
ffffffffc0203df2:	ada60613          	addi	a2,a2,-1318 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203df6:	0e900593          	li	a1,233
ffffffffc0203dfa:	00003517          	auipc	a0,0x3
ffffffffc0203dfe:	aa650513          	addi	a0,a0,-1370 # ffffffffc02068a0 <default_pmm_manager+0xc28>
ffffffffc0203e02:	e44fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203e06:	00003697          	auipc	a3,0x3
ffffffffc0203e0a:	b0a68693          	addi	a3,a3,-1270 # ffffffffc0206910 <default_pmm_manager+0xc98>
ffffffffc0203e0e:	00002617          	auipc	a2,0x2
ffffffffc0203e12:	aba60613          	addi	a2,a2,-1350 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203e16:	0d600593          	li	a1,214
ffffffffc0203e1a:	00003517          	auipc	a0,0x3
ffffffffc0203e1e:	a8650513          	addi	a0,a0,-1402 # ffffffffc02068a0 <default_pmm_manager+0xc28>
ffffffffc0203e22:	e24fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma4 == NULL);
ffffffffc0203e26:	00003697          	auipc	a3,0x3
ffffffffc0203e2a:	b6a68693          	addi	a3,a3,-1174 # ffffffffc0206990 <default_pmm_manager+0xd18>
ffffffffc0203e2e:	00002617          	auipc	a2,0x2
ffffffffc0203e32:	a9a60613          	addi	a2,a2,-1382 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203e36:	0e400593          	li	a1,228
ffffffffc0203e3a:	00003517          	auipc	a0,0x3
ffffffffc0203e3e:	a6650513          	addi	a0,a0,-1434 # ffffffffc02068a0 <default_pmm_manager+0xc28>
ffffffffc0203e42:	e04fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma5 == NULL);
ffffffffc0203e46:	00003697          	auipc	a3,0x3
ffffffffc0203e4a:	b5a68693          	addi	a3,a3,-1190 # ffffffffc02069a0 <default_pmm_manager+0xd28>
ffffffffc0203e4e:	00002617          	auipc	a2,0x2
ffffffffc0203e52:	a7a60613          	addi	a2,a2,-1414 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203e56:	0e600593          	li	a1,230
ffffffffc0203e5a:	00003517          	auipc	a0,0x3
ffffffffc0203e5e:	a4650513          	addi	a0,a0,-1466 # ffffffffc02068a0 <default_pmm_manager+0xc28>
ffffffffc0203e62:	de4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1 != NULL);
ffffffffc0203e66:	00003697          	auipc	a3,0x3
ffffffffc0203e6a:	afa68693          	addi	a3,a3,-1286 # ffffffffc0206960 <default_pmm_manager+0xce8>
ffffffffc0203e6e:	00002617          	auipc	a2,0x2
ffffffffc0203e72:	a5a60613          	addi	a2,a2,-1446 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203e76:	0de00593          	li	a1,222
ffffffffc0203e7a:	00003517          	auipc	a0,0x3
ffffffffc0203e7e:	a2650513          	addi	a0,a0,-1498 # ffffffffc02068a0 <default_pmm_manager+0xc28>
ffffffffc0203e82:	dc4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2 != NULL);
ffffffffc0203e86:	00003697          	auipc	a3,0x3
ffffffffc0203e8a:	aea68693          	addi	a3,a3,-1302 # ffffffffc0206970 <default_pmm_manager+0xcf8>
ffffffffc0203e8e:	00002617          	auipc	a2,0x2
ffffffffc0203e92:	a3a60613          	addi	a2,a2,-1478 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203e96:	0e000593          	li	a1,224
ffffffffc0203e9a:	00003517          	auipc	a0,0x3
ffffffffc0203e9e:	a0650513          	addi	a0,a0,-1530 # ffffffffc02068a0 <default_pmm_manager+0xc28>
ffffffffc0203ea2:	da4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma3 == NULL);
ffffffffc0203ea6:	00003697          	auipc	a3,0x3
ffffffffc0203eaa:	ada68693          	addi	a3,a3,-1318 # ffffffffc0206980 <default_pmm_manager+0xd08>
ffffffffc0203eae:	00002617          	auipc	a2,0x2
ffffffffc0203eb2:	a1a60613          	addi	a2,a2,-1510 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203eb6:	0e200593          	li	a1,226
ffffffffc0203eba:	00003517          	auipc	a0,0x3
ffffffffc0203ebe:	9e650513          	addi	a0,a0,-1562 # ffffffffc02068a0 <default_pmm_manager+0xc28>
ffffffffc0203ec2:	d84fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203ec6:	00003697          	auipc	a3,0x3
ffffffffc0203eca:	c3a68693          	addi	a3,a3,-966 # ffffffffc0206b00 <default_pmm_manager+0xe88>
ffffffffc0203ece:	00002617          	auipc	a2,0x2
ffffffffc0203ed2:	9fa60613          	addi	a2,a2,-1542 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203ed6:	10100593          	li	a1,257
ffffffffc0203eda:	00003517          	auipc	a0,0x3
ffffffffc0203ede:	9c650513          	addi	a0,a0,-1594 # ffffffffc02068a0 <default_pmm_manager+0xc28>
    check_mm_struct = mm_create();
...
ffffffffc0203ef2:	4d268693          	addi	a3,a3,1234 # ffffffffc02063c0 <default_pmm_manager+0x748>
ffffffffc0203ef6:	00002617          	auipc	a2,0x2
ffffffffc0203efa:	9d260613          	addi	a2,a2,-1582 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203efe:	10800593          	li	a1,264
ffffffffc0203f02:	00003517          	auipc	a0,0x3
ffffffffc0203f06:	99e50513          	addi	a0,a0,-1634 # ffffffffc02068a0 <default_pmm_manager+0xc28>
ffffffffc0203f0a:	d3cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203f0e:	00003697          	auipc	a3,0x3
ffffffffc0203f12:	b6268693          	addi	a3,a3,-1182 # ffffffffc0206a70 <default_pmm_manager+0xdf8>
ffffffffc0203f16:	00002617          	auipc	a2,0x2
ffffffffc0203f1a:	9b260613          	addi	a2,a2,-1614 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203f1e:	10d00593          	li	a1,269
ffffffffc0203f22:	00003517          	auipc	a0,0x3
ffffffffc0203f26:	97e50513          	addi	a0,a0,-1666 # ffffffffc02068a0 <default_pmm_manager+0xc28>
ffffffffc0203f2a:	d1cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(sum == 0);
ffffffffc0203f2e:	00003697          	auipc	a3,0x3
ffffffffc0203f32:	b6268693          	addi	a3,a3,-1182 # ffffffffc0206a90 <default_pmm_manager+0xe18>
ffffffffc0203f36:	00002617          	auipc	a2,0x2
ffffffffc0203f3a:	99260613          	addi	a2,a2,-1646 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203f3e:	11700593          	li	a1,279
ffffffffc0203f42:	00003517          	auipc	a0,0x3
ffffffffc0203f46:	95e50513          	addi	a0,a0,-1698 # ffffffffc02068a0 <default_pmm_manager+0xc28>
ffffffffc0203f4a:	cfcfc0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203f4e:	00002617          	auipc	a2,0x2
ffffffffc0203f52:	e3260613          	addi	a2,a2,-462 # ffffffffc0205d80 <default_pmm_manager+0x108>
ffffffffc0203f56:	06300593          	li	a1,99
ffffffffc0203f5a:	00002517          	auipc	a0,0x2
ffffffffc0203f5e:	d7e50513          	addi	a0,a0,-642 # ffffffffc0205cd8 <default_pmm_manager+0x60>
ffffffffc0203f62:	ce4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc0203f66:	00002617          	auipc	a2,0x2
ffffffffc0203f6a:	d4a60613          	addi	a2,a2,-694 # ffffffffc0205cb0 <default_pmm_manager+0x38>
ffffffffc0203f6e:	06a00593          	li	a1,106
ffffffffc0203f72:	00002517          	auipc	a0,0x2
ffffffffc0203f76:	d6650513          	addi	a0,a0,-666 # ffffffffc0205cd8 <default_pmm_manager+0x60>
ffffffffc0203f7a:	cccfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203f7e:	00003697          	auipc	a3,0x3
ffffffffc0203f82:	b2268693          	addi	a3,a3,-1246 # ffffffffc0206aa0 <default_pmm_manager+0xe28>
ffffffffc0203f86:	00002617          	auipc	a2,0x2
ffffffffc0203f8a:	94260613          	addi	a2,a2,-1726 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203f8e:	12400593          	li	a1,292
ffffffffc0203f92:	00003517          	auipc	a0,0x3
ffffffffc0203f96:	90e50513          	addi	a0,a0,-1778 # ffffffffc02068a0 <default_pmm_manager+0xc28>
ffffffffc0203f9a:	cacfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203f9e:	00002697          	auipc	a3,0x2
ffffffffc0203fa2:	41268693          	addi	a3,a3,1042 # ffffffffc02063b0 <default_pmm_manager+0x738>
ffffffffc0203fa6:	00002617          	auipc	a2,0x2
ffffffffc0203faa:	92260613          	addi	a2,a2,-1758 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203fae:	10500593          	li	a1,261
ffffffffc0203fb2:	00003517          	auipc	a0,0x3
ffffffffc0203fb6:	8ee50513          	addi	a0,a0,-1810 # ffffffffc02068a0 <default_pmm_manager+0xc28>
ffffffffc0203fba:	c8cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(mm != NULL);
ffffffffc0203fbe:	00002697          	auipc	a3,0x2
ffffffffc0203fc2:	3ca68693          	addi	a3,a3,970 # ffffffffc0206388 <default_pmm_manager+0x710>
ffffffffc0203fc6:	00002617          	auipc	a2,0x2
ffffffffc0203fca:	90260613          	addi	a2,a2,-1790 # ffffffffc02058c8 <commands+0x738>
ffffffffc0203fce:	0c200593          	li	a1,194
ffffffffc0203fd2:	00003517          	auipc	a0,0x3
ffffffffc0203fd6:	8ce50513          	addi	a0,a0,-1842 # ffffffffc02068a0 <default_pmm_manager+0xc28>
...
ffffffffc0204080:	aec50513          	addi	a0,a0,-1300 # ffffffffc0206b68 <default_pmm_manager+0xef0>
...
ffffffffc0204092:	a8a50513          	addi	a0,a0,-1398 # ffffffffc0206b18 <default_pmm_manager+0xea0>
...
ffffffffc02040a2:	af250513          	addi	a0,a0,-1294 # ffffffffc0206b90 <default_pmm_manager+0xf18>
...
ffffffffc02040b2:	a9a50513          	addi	a0,a0,-1382 # ffffffffc0206b48 <default_pmm_manager+0xed0>
...
ffffffffc02040e4:	ad860613          	addi	a2,a2,-1320 # ffffffffc0206bb8 <default_pmm_manager+0xf40>
ffffffffc02040e8:	45b5                	li	a1,13
ffffffffc02040ea:	00003517          	auipc	a0,0x3
ffffffffc02040ee:	aee50513          	addi	a0,a0,-1298 # ffffffffc0206bd8 <default_pmm_manager+0xf60>
...
ffffffffc020411e:	eee73703          	ld	a4,-274(a4) # ffffffffc0207008 <nbase>
...
ffffffffc0204158:	a9c60613          	addi	a2,a2,-1380 # ffffffffc0206bf0 <default_pmm_manager+0xf78>
ffffffffc020415c:	45d1                	li	a1,20
ffffffffc020415e:	00003517          	auipc	a0,0x3
ffffffffc0204162:	a7a50513          	addi	a0,a0,-1414 # ffffffffc0206bd8 <default_pmm_manager+0xf60>
ffffffffc0204166:	ae0fc0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc020416a:	86b2                	mv	a3,a2
ffffffffc020416c:	06a00593          	li	a1,106
ffffffffc0204170:	00002617          	auipc	a2,0x2
ffffffffc0204174:	b4060613          	addi	a2,a2,-1216 # ffffffffc0205cb0 <default_pmm_manager+0x38>
ffffffffc0204178:	00002517          	auipc	a0,0x2
ffffffffc020417c:	b6050513          	addi	a0,a0,-1184 # ffffffffc0205cd8 <default_pmm_manager+0x60>
...
ffffffffc02041ac:	e6073703          	ld	a4,-416(a4) # ffffffffc0207008 <nbase>
...
ffffffffc02041e6:	a0e60613          	addi	a2,a2,-1522 # ffffffffc0206bf0 <default_pmm_manager+0xf78>
ffffffffc02041ea:	45e5                	li	a1,25
ffffffffc02041ec:	00003517          	auipc	a0,0x3
ffffffffc02041f0:	9ec50513          	addi	a0,a0,-1556 # ffffffffc0206bd8 <default_pmm_manager+0xf60>
ffffffffc02041f4:	a52fc0ef          	jal	ra,ffffffffc0200446 <__panic>
ffffffffc02041f8:	86b2                	mv	a3,a2
ffffffffc02041fa:	06a00593          	li	a1,106
ffffffffc02041fe:	00002617          	auipc	a2,0x2
ffffffffc0204202:	ab260613          	addi	a2,a2,-1358 # ffffffffc0205cb0 <default_pmm_manager+0x38>
ffffffffc0204206:	00002517          	auipc	a0,0x2
ffffffffc020420a:	ad250513          	addi	a0,a0,-1326 # ffffffffc0205cd8 <default_pmm_manager+0x60>
...
ffffffffc0204250:	48b000ef          	jal	ra,ffffffffc0204eda <memset>
...
ffffffffc020426e:	46d000ef          	jal	ra,ffffffffc0204eda <memset>
    }
    return proc;
}
...
ffffffffc02042d8:	96450513          	addi	a0,a0,-1692 # ffffffffc0206c38 <default_pmm_manager+0xfc0>
ffffffffc02042dc:	ea5fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02042e0:	00003517          	auipc	a0,0x3
ffffffffc02042e4:	96850513          	addi	a0,a0,-1688 # ffffffffc0206c48 <default_pmm_manager+0xfd0>
...
ffffffffc02042fe:	f026                	sd	s1,32(sp)
    if (proc != current) {
ffffffffc0204300:	00012497          	auipc	s1,0x12
ffffffffc0204304:	2b048493          	addi	s1,s1,688 # ffffffffc02165b0 <current>
ffffffffc0204308:	6098                	ld	a4,0(s1)
proc_run(struct proc_struct *proc) {
ffffffffc020430a:	f406                	sd	ra,40(sp)
ffffffffc020430c:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc020430e:	02a70863          	beq	a4,a0,ffffffffc020433e <proc_run+0x42>
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204312:	100027f3          	csrr	a5,sstatus
ffffffffc0204316:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204318:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020431a:	ef8d                	bnez	a5,ffffffffc0204354 <proc_run+0x58>
...
ffffffffc020431e:	800006b7          	lui	a3,0x80000
        current = proc; // 切换到新进程
ffffffffc0204322:	e088                	sd	a0,0(s1)
ffffffffc0204324:	00c7d79b          	srliw	a5,a5,0xc
ffffffffc0204328:	8fd5                	or	a5,a5,a3
ffffffffc020432a:	18079073          	csrw	satp,a5
        switch_to(&(temp->context),&(proc->context));
ffffffffc020432e:	03050593          	addi	a1,a0,48
ffffffffc0204332:	03070513          	addi	a0,a4,48
ffffffffc0204336:	5f4000ef          	jal	ra,ffffffffc020492a <switch_to>
    if (flag) {
ffffffffc020433a:	00091763          	bnez	s2,ffffffffc0204348 <proc_run+0x4c>
}
...
ffffffffc0204348:	70a2                	ld	ra,40(sp)
ffffffffc020434a:	7482                	ld	s1,32(sp)
ffffffffc020434c:	6962                	ld	s2,24(sp)
...
ffffffffc020435a:	6098                	ld	a4,0(s1)
        return 1;
ffffffffc020435c:	6522                	ld	a0,8(sp)
ffffffffc020435e:	4905                	li	s2,1
ffffffffc0204360:	bf75                	j	ffffffffc020431c <proc_run+0x20>

ffffffffc0204362 <do_fork>:
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204362:	7179                	addi	sp,sp,-48
ffffffffc0204364:	ec26                	sd	s1,24(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204366:	00012497          	auipc	s1,0x12
ffffffffc020436a:	26248493          	addi	s1,s1,610 # ffffffffc02165c8 <nr_process>
ffffffffc020436e:	4098                	lw	a4,0(s1)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204370:	f406                	sd	ra,40(sp)
ffffffffc0204372:	f022                	sd	s0,32(sp)
ffffffffc0204374:	e84a                	sd	s2,16(sp)
ffffffffc0204376:	e44e                	sd	s3,8(sp)
ffffffffc0204378:	e052                	sd	s4,0(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc020437a:	6785                	lui	a5,0x1
ffffffffc020437c:	26f75163          	bge	a4,a5,ffffffffc02045de <do_fork+0x27c>
ffffffffc0204380:	892e                	mv	s2,a1
ffffffffc0204382:	8432                	mv	s0,a2
    if ((proc = alloc_proc()) == NULL) {
ffffffffc0204384:	e97ff0ef          	jal	ra,ffffffffc020421a <alloc_proc>
ffffffffc0204388:	89aa                	mv	s3,a0
ffffffffc020438a:	24050f63          	beqz	a0,ffffffffc02045e8 <do_fork+0x286>
    proc->parent = current;
ffffffffc020438e:	00012a17          	auipc	s4,0x12
ffffffffc0204392:	222a0a13          	addi	s4,s4,546 # ffffffffc02165b0 <current>
ffffffffc0204396:	000a3783          	ld	a5,0(s4)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc020439a:	4509                	li	a0,2
    proc->parent = current;
ffffffffc020439c:	02f9b023          	sd	a5,32(s3)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043a0:	e8cfd0ef          	jal	ra,ffffffffc0201a2c <alloc_pages>
    if (page != NULL) {
ffffffffc02043a4:	1e050763          	beqz	a0,ffffffffc0204592 <do_fork+0x230>
    return page - pages + nbase;
ffffffffc02043a8:	00012697          	auipc	a3,0x12
ffffffffc02043ac:	1c86b683          	ld	a3,456(a3) # ffffffffc0216570 <pages>
ffffffffc02043b0:	40d506b3          	sub	a3,a0,a3
ffffffffc02043b4:	8699                	srai	a3,a3,0x6
ffffffffc02043b6:	00003517          	auipc	a0,0x3
ffffffffc02043ba:	c5253503          	ld	a0,-942(a0) # ffffffffc0207008 <nbase>
...
ffffffffc02043ca:	1a273703          	ld	a4,418(a4) # ffffffffc0216568 <npage>
    return page2ppn(page) << PGSHIFT;
ffffffffc02043ce:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02043d0:	22e7fe63          	bgeu	a5,a4,ffffffffc020460c <do_fork+0x2aa>
    assert(current->mm == NULL);
ffffffffc02043d4:	000a3783          	ld	a5,0(s4)
ffffffffc02043d8:	00012717          	auipc	a4,0x12
ffffffffc02043dc:	1a873703          	ld	a4,424(a4) # ffffffffc0216580 <va_pa_offset>
ffffffffc02043e0:	96ba                	add	a3,a3,a4
ffffffffc02043e2:	779c                	ld	a5,40(a5)
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc02043e4:	00d9b823          	sd	a3,16(s3)
    assert(current->mm == NULL);
ffffffffc02043e8:	20079263          	bnez	a5,ffffffffc02045ec <do_fork+0x28a>
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02043ec:	6789                	lui	a5,0x2
ffffffffc02043ee:	ee078793          	addi	a5,a5,-288 # 1ee0 <kern_entry-0xffffffffc01fe120>
ffffffffc02043f2:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc02043f4:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02043f6:	0ad9b023          	sd	a3,160(s3)
    *(proc->tf) = *tf;
ffffffffc02043fa:	87b6                	mv	a5,a3
ffffffffc02043fc:	12040893          	addi	a7,s0,288
ffffffffc0204400:	00063803          	ld	a6,0(a2)
ffffffffc0204404:	6608                	ld	a0,8(a2)
ffffffffc0204406:	6a0c                	ld	a1,16(a2)
ffffffffc0204408:	6e18                	ld	a4,24(a2)
ffffffffc020440a:	0107b023          	sd	a6,0(a5)
ffffffffc020440e:	e788                	sd	a0,8(a5)
ffffffffc0204410:	eb8c                	sd	a1,16(a5)
ffffffffc0204412:	ef98                	sd	a4,24(a5)
ffffffffc0204414:	02060613          	addi	a2,a2,32
ffffffffc0204418:	02078793          	addi	a5,a5,32
ffffffffc020441c:	ff1612e3          	bne	a2,a7,ffffffffc0204400 <do_fork+0x9e>
    proc->tf->gpr.a0 = 0;
ffffffffc0204420:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204424:	12090563          	beqz	s2,ffffffffc020454e <do_fork+0x1ec>
ffffffffc0204428:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020442c:	00000797          	auipc	a5,0x0
ffffffffc0204430:	e5078793          	addi	a5,a5,-432 # ffffffffc020427c <forkret>
ffffffffc0204434:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204438:	02d9bc23          	sd	a3,56(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020443c:	100027f3          	csrr	a5,sstatus
ffffffffc0204440:	8b89                	andi	a5,a5,2
    return 0;
ffffffffc0204442:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204444:	12079663          	bnez	a5,ffffffffc0204570 <do_fork+0x20e>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204448:	00007817          	auipc	a6,0x7
ffffffffc020444c:	c1080813          	addi	a6,a6,-1008 # ffffffffc020b058 <last_pid.1>
ffffffffc0204450:	00082783          	lw	a5,0(a6)
ffffffffc0204454:	6709                	lui	a4,0x2
ffffffffc0204456:	0017851b          	addiw	a0,a5,1
ffffffffc020445a:	00a82023          	sw	a0,0(a6)
ffffffffc020445e:	08e55163          	bge	a0,a4,ffffffffc02044e0 <do_fork+0x17e>
    if (last_pid >= next_safe) {
ffffffffc0204462:	00007317          	auipc	t1,0x7
ffffffffc0204466:	bfa30313          	addi	t1,t1,-1030 # ffffffffc020b05c <next_safe.0>
ffffffffc020446a:	00032783          	lw	a5,0(t1)
ffffffffc020446e:	00012417          	auipc	s0,0x12
ffffffffc0204472:	0ba40413          	addi	s0,s0,186 # ffffffffc0216528 <proc_list>
ffffffffc0204476:	06f55d63          	bge	a0,a5,ffffffffc02044f0 <do_fork+0x18e>
        proc->pid = get_pid();
ffffffffc020447a:	00a9a223          	sw	a0,4(s3)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020447e:	45a9                	li	a1,10
ffffffffc0204480:	2501                	sext.w	a0,a0
ffffffffc0204482:	5d8000ef          	jal	ra,ffffffffc0204a5a <hash32>
ffffffffc0204486:	02051793          	slli	a5,a0,0x20
ffffffffc020448a:	01c7d513          	srli	a0,a5,0x1c
ffffffffc020448e:	0000e797          	auipc	a5,0xe
ffffffffc0204492:	08a78793          	addi	a5,a5,138 # ffffffffc0212518 <hash_list>
ffffffffc0204496:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0204498:	6510                	ld	a2,8(a0)
ffffffffc020449a:	0d898793          	addi	a5,s3,216
ffffffffc020449e:	6414                	ld	a3,8(s0)
        nr_process++;
ffffffffc02044a0:	4098                	lw	a4,0(s1)
    prev->next = next->prev = elm;
ffffffffc02044a2:	e21c                	sd	a5,0(a2)
ffffffffc02044a4:	e51c                	sd	a5,8(a0)
    elm->next = next;
ffffffffc02044a6:	0ec9b023          	sd	a2,224(s3)
        list_add(&proc_list, &proc->list_link);
ffffffffc02044aa:	0c898793          	addi	a5,s3,200
    elm->prev = prev;
ffffffffc02044ae:	0ca9bc23          	sd	a0,216(s3)
    prev->next = next->prev = elm;
ffffffffc02044b2:	e29c                	sd	a5,0(a3)
        nr_process++;
ffffffffc02044b4:	2705                	addiw	a4,a4,1
ffffffffc02044b6:	e41c                	sd	a5,8(s0)
    elm->next = next;
ffffffffc02044b8:	0cd9b823          	sd	a3,208(s3)
    elm->prev = prev;
ffffffffc02044bc:	0c89b423          	sd	s0,200(s3)
ffffffffc02044c0:	c098                	sw	a4,0(s1)
    if (flag) {
ffffffffc02044c2:	0a091b63          	bnez	s2,ffffffffc0204578 <do_fork+0x216>
    wakeup_proc(proc);
ffffffffc02044c6:	854e                	mv	a0,s3
ffffffffc02044c8:	4cc000ef          	jal	ra,ffffffffc0204994 <wakeup_proc>
    ret = proc->pid;
...
ffffffffc0204508:	088e0063          	beq	t3,s0,ffffffffc0204588 <do_fork+0x226>
ffffffffc020450c:	88ae                	mv	a7,a1
ffffffffc020450e:	87f2                	mv	a5,t3
ffffffffc0204510:	6609                	lui	a2,0x2
ffffffffc0204512:	a811                	j	ffffffffc0204526 <do_fork+0x1c4>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc0204514:	00e6d663          	bge	a3,a4,ffffffffc0204520 <do_fork+0x1be>
ffffffffc0204518:	00c75463          	bge	a4,a2,ffffffffc0204520 <do_fork+0x1be>
ffffffffc020451c:	863a                	mv	a2,a4
ffffffffc020451e:	4885                	li	a7,1
ffffffffc0204520:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0204522:	00878d63          	beq	a5,s0,ffffffffc020453c <do_fork+0x1da>
            if (proc->pid == last_pid) {
ffffffffc0204526:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc020452a:	fed715e3          	bne	a4,a3,ffffffffc0204514 <do_fork+0x1b2>
                if (++ last_pid >= next_safe) {
ffffffffc020452e:	2685                	addiw	a3,a3,1
ffffffffc0204530:	04c6d763          	bge	a3,a2,ffffffffc020457e <do_fork+0x21c>
ffffffffc0204534:	679c                	ld	a5,8(a5)
ffffffffc0204536:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc0204538:	fe8797e3          	bne	a5,s0,ffffffffc0204526 <do_fork+0x1c4>
ffffffffc020453c:	c581                	beqz	a1,ffffffffc0204544 <do_fork+0x1e2>
ffffffffc020453e:	00d82023          	sw	a3,0(a6)
ffffffffc0204542:	8536                	mv	a0,a3
ffffffffc0204544:	f2088be3          	beqz	a7,ffffffffc020447a <do_fork+0x118>
ffffffffc0204548:	00c32023          	sw	a2,0(t1)
ffffffffc020454c:	b73d                	j	ffffffffc020447a <do_fork+0x118>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020454e:	8936                	mv	s2,a3
ffffffffc0204550:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204554:	00000797          	auipc	a5,0x0
ffffffffc0204558:	d2878793          	addi	a5,a5,-728 # ffffffffc020427c <forkret>
...
ffffffffc020456a:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020456c:	ec078ee3          	beqz	a5,ffffffffc0204448 <do_fork+0xe6>
        intr_disable();
ffffffffc0204570:	852fc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204574:	4905                	li	s2,1
ffffffffc0204576:	bdc9                	j	ffffffffc0204448 <do_fork+0xe6>
        intr_enable();
ffffffffc0204578:	844fc0ef          	jal	ra,ffffffffc02005bc <intr_enable>
ffffffffc020457c:	b7a9                	j	ffffffffc02044c6 <do_fork+0x164>
                    if (last_pid >= MAX_PID) {
ffffffffc020457e:	01d6c363          	blt	a3,t4,ffffffffc0204584 <do_fork+0x222>
                        last_pid = 1;
ffffffffc0204582:	4685                	li	a3,1
                    goto repeat;
ffffffffc0204584:	4585                	li	a1,1
ffffffffc0204586:	b749                	j	ffffffffc0204508 <do_fork+0x1a6>
ffffffffc0204588:	cda9                	beqz	a1,ffffffffc02045e2 <do_fork+0x280>
ffffffffc020458a:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc020458e:	8536                	mv	a0,a3
ffffffffc0204590:	b5ed                	j	ffffffffc020447a <do_fork+0x118>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc0204592:	0109b683          	ld	a3,16(s3)
    return pa2page(PADDR(kva));
ffffffffc0204596:	c02007b7          	lui	a5,0xc0200
ffffffffc020459a:	0af6e163          	bltu	a3,a5,ffffffffc020463c <do_fork+0x2da>
ffffffffc020459e:	00012797          	auipc	a5,0x12
ffffffffc02045a2:	fe27b783          	ld	a5,-30(a5) # ffffffffc0216580 <va_pa_offset>
ffffffffc02045a6:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc02045aa:	83b1                	srli	a5,a5,0xc
ffffffffc02045ac:	00012717          	auipc	a4,0x12
ffffffffc02045b0:	fbc73703          	ld	a4,-68(a4) # ffffffffc0216568 <npage>
ffffffffc02045b4:	06e7f863          	bgeu	a5,a4,ffffffffc0204624 <do_fork+0x2c2>
    return &pages[PPN(pa) - nbase];
ffffffffc02045b8:	00003717          	auipc	a4,0x3
ffffffffc02045bc:	a5073703          	ld	a4,-1456(a4) # ffffffffc0207008 <nbase>
ffffffffc02045c0:	8f99                	sub	a5,a5,a4
ffffffffc02045c2:	079a                	slli	a5,a5,0x6
ffffffffc02045c4:	00012517          	auipc	a0,0x12
ffffffffc02045c8:	fac53503          	ld	a0,-84(a0) # ffffffffc0216570 <pages>
ffffffffc02045cc:	953e                	add	a0,a0,a5
ffffffffc02045ce:	4589                	li	a1,2
ffffffffc02045d0:	ceefd0ef          	jal	ra,ffffffffc0201abe <free_pages>
    kfree(proc);
ffffffffc02045d4:	854e                	mv	a0,s3
ffffffffc02045d6:	b28fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    ret = -E_NO_MEM;
ffffffffc02045da:	5571                	li	a0,-4
    goto fork_out;
ffffffffc02045dc:	bdd5                	j	ffffffffc02044d0 <do_fork+0x16e>
    int ret = -E_NO_FREE_PROC;
ffffffffc02045de:	556d                	li	a0,-5
ffffffffc02045e0:	bdc5                	j	ffffffffc02044d0 <do_fork+0x16e>
    return last_pid;
ffffffffc02045e2:	00082503          	lw	a0,0(a6)
ffffffffc02045e6:	bd51                	j	ffffffffc020447a <do_fork+0x118>
    ret = -E_NO_MEM;
ffffffffc02045e8:	5571                	li	a0,-4
    return ret;
ffffffffc02045ea:	b5dd                	j	ffffffffc02044d0 <do_fork+0x16e>
    assert(current->mm == NULL);
ffffffffc02045ec:	00002697          	auipc	a3,0x2
ffffffffc02045f0:	67c68693          	addi	a3,a3,1660 # ffffffffc0206c68 <default_pmm_manager+0xff0>
ffffffffc02045f4:	00001617          	auipc	a2,0x1
ffffffffc02045f8:	2d460613          	addi	a2,a2,724 # ffffffffc02058c8 <commands+0x738>
ffffffffc02045fc:	12800593          	li	a1,296
ffffffffc0204600:	00002517          	auipc	a0,0x2
ffffffffc0204604:	68050513          	addi	a0,a0,1664 # ffffffffc0206c80 <default_pmm_manager+0x1008>
ffffffffc0204608:	e3ffb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc020460c:	00001617          	auipc	a2,0x1
ffffffffc0204610:	6a460613          	addi	a2,a2,1700 # ffffffffc0205cb0 <default_pmm_manager+0x38>
ffffffffc0204614:	06a00593          	li	a1,106
ffffffffc0204618:	00001517          	auipc	a0,0x1
ffffffffc020461c:	6c050513          	addi	a0,a0,1728 # ffffffffc0205cd8 <default_pmm_manager+0x60>
ffffffffc0204620:	e27fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204624:	00001617          	auipc	a2,0x1
ffffffffc0204628:	75c60613          	addi	a2,a2,1884 # ffffffffc0205d80 <default_pmm_manager+0x108>
ffffffffc020462c:	06300593          	li	a1,99
ffffffffc0204630:	00001517          	auipc	a0,0x1
ffffffffc0204634:	6a850513          	addi	a0,a0,1704 # ffffffffc0205cd8 <default_pmm_manager+0x60>
ffffffffc0204638:	e0ffb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return pa2page(PADDR(kva));
ffffffffc020463c:	00001617          	auipc	a2,0x1
ffffffffc0204640:	71c60613          	addi	a2,a2,1820 # ffffffffc0205d58 <default_pmm_manager+0xe0>
ffffffffc0204644:	06f00593          	li	a1,111
ffffffffc0204648:	00001517          	auipc	a0,0x1
ffffffffc020464c:	69050513          	addi	a0,a0,1680 # ffffffffc0205cd8 <default_pmm_manager+0x60>
...
ffffffffc020466a:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc020466c:	06f000ef          	jal	ra,ffffffffc0204eda <memset>
...
ffffffffc0204692:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204694:	ccfff0ef          	jal	ra,ffffffffc0204362 <do_fork>
}
...
ffffffffc02046aa:	5f260613          	addi	a2,a2,1522 # ffffffffc0206c98 <default_pmm_manager+0x1020>
ffffffffc02046ae:	18900593          	li	a1,393
ffffffffc02046b2:	00002517          	auipc	a0,0x2
ffffffffc02046b6:	5ce50513          	addi	a0,a0,1486 # ffffffffc0206c80 <default_pmm_manager+0x1008>
do_exit(int error_code) {
ffffffffc02046ba:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc02046bc:	d8bfb0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc02046c2:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc02046c4:	00012797          	auipc	a5,0x12
ffffffffc02046c8:	e6478793          	addi	a5,a5,-412 # ffffffffc0216528 <proc_list>
...
ffffffffc02046d4:	0000e497          	auipc	s1,0xe
ffffffffc02046d8:	e4448493          	addi	s1,s1,-444 # ffffffffc0212518 <hash_list>
...
ffffffffc02046e0:	00012717          	auipc	a4,0x12
ffffffffc02046e4:	e3870713          	addi	a4,a4,-456 # ffffffffc0216518 <name.2>
...
ffffffffc02046f4:	b27ff0ef          	jal	ra,ffffffffc020421a <alloc_proc>
ffffffffc02046f8:	00012917          	auipc	s2,0x12
ffffffffc02046fc:	ec090913          	addi	s2,s2,-320 # ffffffffc02165b8 <idleproc>
...
ffffffffc020470c:	942fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
...
ffffffffc0204716:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc0204718:	7c2000ef          	jal	ra,ffffffffc0204eda <memset>
...
ffffffffc020472a:	7da000ef          	jal	ra,ffffffffc0204f04 <memcmp>
ffffffffc020472e:	89aa                	mv	s3,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc0204730:	453d                	li	a0,15
ffffffffc0204732:	91cfd0ef          	jal	ra,ffffffffc020184e <kmalloc>
...
ffffffffc020473a:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc020473c:	79e000ef          	jal	ra,ffffffffc0204eda <memset>
...
ffffffffc020474c:	7b8000ef          	jal	ra,ffffffffc0204f04 <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204750:	00093783          	ld	a5,0(s2)
ffffffffc0204754:	00012717          	auipc	a4,0x12
ffffffffc0204758:	e0473703          	ld	a4,-508(a4) # ffffffffc0216558 <boot_cr3>
...
ffffffffc0204766:	00004717          	auipc	a4,0x4
ffffffffc020476a:	89a70713          	addi	a4,a4,-1894 # ffffffffc0208000 <bootstack>
...
ffffffffc020477e:	75c000ef          	jal	ra,ffffffffc0204eda <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204782:	463d                	li	a2,15
ffffffffc0204784:	00002597          	auipc	a1,0x2
ffffffffc0204788:	55c58593          	addi	a1,a1,1372 # ffffffffc0206ce0 <default_pmm_manager+0x1068>
ffffffffc020478c:	8522                	mv	a0,s0
ffffffffc020478e:	75e000ef          	jal	ra,ffffffffc0204eec <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc0204792:	00012717          	auipc	a4,0x12
ffffffffc0204796:	e3670713          	addi	a4,a4,-458 # ffffffffc02165c8 <nr_process>
...
ffffffffc02047a8:	54458593          	addi	a1,a1,1348 # ffffffffc0206ce8 <default_pmm_manager+0x1070>
ffffffffc02047ac:	00000517          	auipc	a0,0x0
ffffffffc02047b0:	ade50513          	addi	a0,a0,-1314 # ffffffffc020428a <init_main>
    nr_process ++;
ffffffffc02047b4:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc02047b6:	00012797          	auipc	a5,0x12
ffffffffc02047ba:	ded7bd23          	sd	a3,-518(a5) # ffffffffc02165b0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
...
ffffffffc02047d8:	282000ef          	jal	ra,ffffffffc0204a5a <hash32>
...
ffffffffc0204802:	00012417          	auipc	s0,0x12
ffffffffc0204806:	dbe40413          	addi	s0,s0,-578 # ffffffffc02165c0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020480a:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc020480c:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020480e:	6cc000ef          	jal	ra,ffffffffc0204eda <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204812:	463d                	li	a2,15
ffffffffc0204814:	00002597          	auipc	a1,0x2
ffffffffc0204818:	50458593          	addi	a1,a1,1284 # ffffffffc0206d18 <default_pmm_manager+0x10a0>
ffffffffc020481c:	8526                	mv	a0,s1
ffffffffc020481e:	6ce000ef          	jal	ra,ffffffffc0204eec <memcpy>
...
ffffffffc020488a:	44250513          	addi	a0,a0,1090 # ffffffffc0206cc8 <default_pmm_manager+0x1050>
...
ffffffffc02048a2:	41260613          	addi	a2,a2,1042 # ffffffffc0206cb0 <default_pmm_manager+0x1038>
ffffffffc02048a6:	1a100593          	li	a1,417
ffffffffc02048aa:	00002517          	auipc	a0,0x2
ffffffffc02048ae:	3d650513          	addi	a0,a0,982 # ffffffffc0206c80 <default_pmm_manager+0x1008>
ffffffffc02048b2:	b95fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc02048b6:	00002617          	auipc	a2,0x2
ffffffffc02048ba:	44260613          	addi	a2,a2,1090 # ffffffffc0206cf8 <default_pmm_manager+0x1080>
ffffffffc02048be:	1c100593          	li	a1,449
ffffffffc02048c2:	00002517          	auipc	a0,0x2
ffffffffc02048c6:	3be50513          	addi	a0,a0,958 # ffffffffc0206c80 <default_pmm_manager+0x1008>
ffffffffc02048ca:	b7dfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02048ce:	00002697          	auipc	a3,0x2
ffffffffc02048d2:	47a68693          	addi	a3,a3,1146 # ffffffffc0206d48 <default_pmm_manager+0x10d0>
ffffffffc02048d6:	00001617          	auipc	a2,0x1
ffffffffc02048da:	ff260613          	addi	a2,a2,-14 # ffffffffc02058c8 <commands+0x738>
ffffffffc02048de:	1c800593          	li	a1,456
ffffffffc02048e2:	00002517          	auipc	a0,0x2
ffffffffc02048e6:	39e50513          	addi	a0,a0,926 # ffffffffc0206c80 <default_pmm_manager+0x1008>
ffffffffc02048ea:	b5dfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc02048ee:	00002697          	auipc	a3,0x2
ffffffffc02048f2:	43268693          	addi	a3,a3,1074 # ffffffffc0206d20 <default_pmm_manager+0x10a8>
ffffffffc02048f6:	00001617          	auipc	a2,0x1
ffffffffc02048fa:	fd260613          	addi	a2,a2,-46 # ffffffffc02058c8 <commands+0x738>
ffffffffc02048fe:	1c700593          	li	a1,455
ffffffffc0204902:	00002517          	auipc	a0,0x2
ffffffffc0204906:	37e50513          	addi	a0,a0,894 # ffffffffc0206c80 <default_pmm_manager+0x1008>
...
ffffffffc0204918:	c9c40413          	addi	s0,s0,-868 # ffffffffc02165b0 <current>
    while (1) {
...
ffffffffc0204922:	dff5                	beqz	a5,ffffffffc020491e <cpu_idle+0x10>
            schedule();
ffffffffc0204924:	0a2000ef          	jal	ra,ffffffffc02049c6 <schedule>
ffffffffc0204928:	bfd5                	j	ffffffffc020491c <cpu_idle+0xe>

ffffffffc020492a <switch_to>:
.text
...
ffffffffc020492a:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc020492e:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0204932:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0204934:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc0204936:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc020493a:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc020493e:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0204942:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc0204946:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc020494a:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc020494e:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0204952:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc0204956:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc020495a:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc020495e:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0204962:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc0204966:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0204968:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc020496a:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc020496e:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0204972:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc0204976:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc020497a:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc020497e:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0204982:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc0204986:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc020498a:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc020498e:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc0204992:	8082                	ret

ffffffffc0204994 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc0204994:	411c                	lw	a5,0(a0)
ffffffffc0204996:	4705                	li	a4,1
ffffffffc0204998:	37f9                	addiw	a5,a5,-2
ffffffffc020499a:	00f77563          	bgeu	a4,a5,ffffffffc02049a4 <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc020499e:	4789                	li	a5,2
ffffffffc02049a0:	c11c                	sw	a5,0(a0)
ffffffffc02049a2:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc02049a4:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02049a6:	00002697          	auipc	a3,0x2
ffffffffc02049aa:	3ca68693          	addi	a3,a3,970 # ffffffffc0206d70 <default_pmm_manager+0x10f8>
ffffffffc02049ae:	00001617          	auipc	a2,0x1
ffffffffc02049b2:	f1a60613          	addi	a2,a2,-230 # ffffffffc02058c8 <commands+0x738>
ffffffffc02049b6:	45a5                	li	a1,9
ffffffffc02049b8:	00002517          	auipc	a0,0x2
ffffffffc02049bc:	3f850513          	addi	a0,a0,1016 # ffffffffc0206db0 <default_pmm_manager+0x1138>
wakeup_proc(struct proc_struct *proc) {
ffffffffc02049c0:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02049c2:	a85fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02049c6 <schedule>:
}
...
ffffffffc02049ca:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02049cc:	100027f3          	csrr	a5,sstatus
ffffffffc02049d0:	8b89                	andi	a5,a5,2
ffffffffc02049d2:	4401                	li	s0,0
ffffffffc02049d4:	efbd                	bnez	a5,ffffffffc0204a52 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc02049d6:	00012897          	auipc	a7,0x12
ffffffffc02049da:	bda8b883          	ld	a7,-1062(a7) # ffffffffc02165b0 <current>
ffffffffc02049de:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02049e2:	00012517          	auipc	a0,0x12
ffffffffc02049e6:	bd653503          	ld	a0,-1066(a0) # ffffffffc02165b8 <idleproc>
ffffffffc02049ea:	04a88e63          	beq	a7,a0,ffffffffc0204a46 <schedule+0x80>
ffffffffc02049ee:	0c888693          	addi	a3,a7,200
ffffffffc02049f2:	00012617          	auipc	a2,0x12
ffffffffc02049f6:	b3660613          	addi	a2,a2,-1226 # ffffffffc0216528 <proc_list>
        le = last;
ffffffffc02049fa:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
ffffffffc02049fc:	4581                	li	a1,0
        do {
            if ((le = list_next(le)) != &proc_list) {
                next = le2proc(le, list_link);
                if (next->state == PROC_RUNNABLE) {
ffffffffc02049fe:	4809                	li	a6,2
ffffffffc0204a00:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0204a02:	00c78863          	beq	a5,a2,ffffffffc0204a12 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204a06:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc0204a0a:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204a0e:	03070163          	beq	a4,a6,ffffffffc0204a30 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc0204a12:	fef697e3          	bne	a3,a5,ffffffffc0204a00 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204a16:	ed89                	bnez	a1,ffffffffc0204a30 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc0204a18:	451c                	lw	a5,8(a0)
ffffffffc0204a1a:	2785                	addiw	a5,a5,1
ffffffffc0204a1c:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc0204a1e:	00a88463          	beq	a7,a0,ffffffffc0204a26 <schedule+0x60>
            proc_run(next);
ffffffffc0204a22:	8dbff0ef          	jal	ra,ffffffffc02042fc <proc_run>
    if (flag) {
ffffffffc0204a26:	e819                	bnez	s0,ffffffffc0204a3c <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc0204a28:	60a2                	ld	ra,8(sp)
ffffffffc0204a2a:	6402                	ld	s0,0(sp)
ffffffffc0204a2c:	0141                	addi	sp,sp,16
ffffffffc0204a2e:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204a30:	4198                	lw	a4,0(a1)
ffffffffc0204a32:	4789                	li	a5,2
ffffffffc0204a34:	fef712e3          	bne	a4,a5,ffffffffc0204a18 <schedule+0x52>
ffffffffc0204a38:	852e                	mv	a0,a1
ffffffffc0204a3a:	bff9                	j	ffffffffc0204a18 <schedule+0x52>
}
ffffffffc0204a3c:	6402                	ld	s0,0(sp)
ffffffffc0204a3e:	60a2                	ld	ra,8(sp)
ffffffffc0204a40:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0204a42:	b7bfb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204a46:	00012617          	auipc	a2,0x12
ffffffffc0204a4a:	ae260613          	addi	a2,a2,-1310 # ffffffffc0216528 <proc_list>
ffffffffc0204a4e:	86b2                	mv	a3,a2
ffffffffc0204a50:	b76d                	j	ffffffffc02049fa <schedule+0x34>
        intr_disable();
ffffffffc0204a52:	b71fb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204a56:	4405                	li	s0,1
ffffffffc0204a58:	bfbd                	j	ffffffffc02049d6 <schedule+0x10>

ffffffffc0204a5a <hash32>:
 *
...
ffffffffc0204a5a:	9e3707b7          	lui	a5,0x9e370
ffffffffc0204a5e:	2785                	addiw	a5,a5,1
ffffffffc0204a60:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0204a64:	02000793          	li	a5,32
ffffffffc0204a68:	9f8d                	subw	a5,a5,a1
}
ffffffffc0204a6a:	00f5553b          	srlw	a0,a0,a5
ffffffffc0204a6e:	8082                	ret

ffffffffc0204a70 <printnum>:
 * */
static void
...
ffffffffc0204a70:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a74:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0204a76:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a7a:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0204a7c:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a80:	f022                	sd	s0,32(sp)
ffffffffc0204a82:	ec26                	sd	s1,24(sp)
ffffffffc0204a84:	e84a                	sd	s2,16(sp)
ffffffffc0204a86:	f406                	sd	ra,40(sp)
ffffffffc0204a88:	e44e                	sd	s3,8(sp)
ffffffffc0204a8a:	84aa                	mv	s1,a0
ffffffffc0204a8c:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0204a8e:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0204a92:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204a94:	03067e63          	bgeu	a2,a6,ffffffffc0204ad0 <printnum+0x60>
ffffffffc0204a98:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0204a9a:	00805763          	blez	s0,ffffffffc0204aa8 <printnum+0x38>
ffffffffc0204a9e:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0204aa0:	85ca                	mv	a1,s2
ffffffffc0204aa2:	854e                	mv	a0,s3
ffffffffc0204aa4:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204aa6:	fc65                	bnez	s0,ffffffffc0204a9e <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204aa8:	1a02                	slli	s4,s4,0x20
ffffffffc0204aaa:	00002797          	auipc	a5,0x2
ffffffffc0204aae:	31e78793          	addi	a5,a5,798 # ffffffffc0206dc8 <default_pmm_manager+0x1150>
ffffffffc0204ab2:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204ab6:	9a3e                	add	s4,s4,a5
}
ffffffffc0204ab8:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204aba:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204abe:	70a2                	ld	ra,40(sp)
ffffffffc0204ac0:	69a2                	ld	s3,8(sp)
...
ffffffffc0204acc:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204ace:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204ad0:	03065633          	divu	a2,a2,a6
ffffffffc0204ad4:	8722                	mv	a4,s0
ffffffffc0204ad6:	f9bff0ef          	jal	ra,ffffffffc0204a70 <printnum>
ffffffffc0204ada:	b7f9                	j	ffffffffc0204aa8 <printnum+0x38>
...
ffffffffc0204adc:	7119                	addi	sp,sp,-128
...
ffffffffc0204aea:	fc5e                	sd	s7,56(sp)
ffffffffc0204aec:	f06a                	sd	s10,32(sp)
ffffffffc0204aee:	fc86                	sd	ra,120(sp)
ffffffffc0204af0:	f8a2                	sd	s0,112(sp)
ffffffffc0204af2:	f862                	sd	s8,48(sp)
ffffffffc0204af4:	f466                	sd	s9,40(sp)
ffffffffc0204af6:	ec6e                	sd	s11,24(sp)
ffffffffc0204af8:	892a                	mv	s2,a0
ffffffffc0204afa:	84ae                	mv	s1,a1
ffffffffc0204afc:	8d32                	mv	s10,a2
...
ffffffffc0204b06:	00002a97          	auipc	s5,0x2
ffffffffc0204b0a:	2eea8a93          	addi	s5,s5,750 # ffffffffc0206df4 <default_pmm_manager+0x117c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204b0e:	00002b97          	auipc	s7,0x2
ffffffffc0204b12:	4c2b8b93          	addi	s7,s7,1218 # ffffffffc0206fd0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b16:	000d4503          	lbu	a0,0(s10)
ffffffffc0204b1a:	001d0413          	addi	s0,s10,1
ffffffffc0204b1e:	01350a63          	beq	a0,s3,ffffffffc0204b32 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204b22:	c121                	beqz	a0,ffffffffc0204b62 <vprintfmt+0x86>
            putch(ch, putdat);
...
ffffffffc0204b2e:	ff351ae3          	bne	a0,s3,ffffffffc0204b22 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b32:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204b36:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204b3a:	4c81                	li	s9,0
ffffffffc0204b3c:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204b3e:	5c7d                	li	s8,-1
ffffffffc0204b40:	5dfd                	li	s11,-1
ffffffffc0204b42:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204b46:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b48:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b4c:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b50:	00140d13          	addi	s10,s0,1
ffffffffc0204b54:	04b56263          	bltu	a0,a1,ffffffffc0204b98 <vprintfmt+0xbc>
ffffffffc0204b58:	058a                	slli	a1,a1,0x2
ffffffffc0204b5a:	95d6                	add	a1,a1,s5
ffffffffc0204b5c:	4194                	lw	a3,0(a1)
ffffffffc0204b5e:	96d6                	add	a3,a3,s5
...
ffffffffc0204b7e:	8082                	ret
            padc = '0';
ffffffffc0204b80:	87b2                	mv	a5,a2
            goto reswitch;
ffffffffc0204b82:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b86:	846a                	mv	s0,s10
ffffffffc0204b88:	00140d13          	addi	s10,s0,1
ffffffffc0204b8c:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b90:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b94:	fcb572e3          	bgeu	a0,a1,ffffffffc0204b58 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204b98:	85a6                	mv	a1,s1
ffffffffc0204b9a:	02500513          	li	a0,37
ffffffffc0204b9e:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204ba0:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204ba4:	8d22                	mv	s10,s0
ffffffffc0204ba6:	f73788e3          	beq	a5,s3,ffffffffc0204b16 <vprintfmt+0x3a>
ffffffffc0204baa:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204bae:	1d7d                	addi	s10,s10,-1
ffffffffc0204bb0:	ff379de3          	bne	a5,s3,ffffffffc0204baa <vprintfmt+0xce>
ffffffffc0204bb4:	b78d                	j	ffffffffc0204b16 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204bb6:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204bba:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bbe:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204bc0:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204bc4:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204bc8:	02d86463          	bltu	a6,a3,ffffffffc0204bf0 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204bcc:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204bd0:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204bd4:	0186873b          	addw	a4,a3,s8
ffffffffc0204bd8:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204bdc:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204bde:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204be2:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204be4:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204be8:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204bec:	fed870e3          	bgeu	a6,a3,ffffffffc0204bcc <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204bf0:	f40ddce3          	bgez	s11,ffffffffc0204b48 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204bf4:	8de2                	mv	s11,s8
ffffffffc0204bf6:	5c7d                	li	s8,-1
ffffffffc0204bf8:	bf81                	j	ffffffffc0204b48 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204bfa:	fffdc693          	not	a3,s11
ffffffffc0204bfe:	96fd                	srai	a3,a3,0x3f
ffffffffc0204c00:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c04:	00144603          	lbu	a2,1(s0)
ffffffffc0204c08:	2d81                	sext.w	s11,s11
ffffffffc0204c0a:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c0c:	bf35                	j	ffffffffc0204b48 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204c0e:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c12:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204c16:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c18:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204c1a:	bfd9                	j	ffffffffc0204bf0 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204c1c:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c1e:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c22:	01174463          	blt	a4,a7,ffffffffc0204c2a <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204c26:	1a088e63          	beqz	a7,ffffffffc0204de2 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204c2a:	000a3603          	ld	a2,0(s4)
ffffffffc0204c2e:	46c1                	li	a3,16
ffffffffc0204c30:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204c32:	2781                	sext.w	a5,a5
ffffffffc0204c34:	876e                	mv	a4,s11
ffffffffc0204c36:	85a6                	mv	a1,s1
ffffffffc0204c38:	854a                	mv	a0,s2
ffffffffc0204c3a:	e37ff0ef          	jal	ra,ffffffffc0204a70 <printnum>
            break;
ffffffffc0204c3e:	bde1                	j	ffffffffc0204b16 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204c40:	000a2503          	lw	a0,0(s4)
ffffffffc0204c44:	85a6                	mv	a1,s1
ffffffffc0204c46:	0a21                	addi	s4,s4,8
ffffffffc0204c48:	9902                	jalr	s2
            break;
ffffffffc0204c4a:	b5f1                	j	ffffffffc0204b16 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204c4c:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c4e:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c52:	01174463          	blt	a4,a7,ffffffffc0204c5a <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204c56:	18088163          	beqz	a7,ffffffffc0204dd8 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204c5a:	000a3603          	ld	a2,0(s4)
ffffffffc0204c5e:	46a9                	li	a3,10
ffffffffc0204c60:	8a2e                	mv	s4,a1
ffffffffc0204c62:	bfc1                	j	ffffffffc0204c32 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c64:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204c68:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c6a:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c6c:	bdf1                	j	ffffffffc0204b48 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204c6e:	85a6                	mv	a1,s1
ffffffffc0204c70:	02500513          	li	a0,37
ffffffffc0204c74:	9902                	jalr	s2
            break;
ffffffffc0204c76:	b545                	j	ffffffffc0204b16 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c78:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204c7c:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c7e:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c80:	b5e1                	j	ffffffffc0204b48 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204c82:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c84:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c88:	01174463          	blt	a4,a7,ffffffffc0204c90 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204c8c:	14088163          	beqz	a7,ffffffffc0204dce <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204c90:	000a3603          	ld	a2,0(s4)
ffffffffc0204c94:	46a1                	li	a3,8
ffffffffc0204c96:	8a2e                	mv	s4,a1
ffffffffc0204c98:	bf69                	j	ffffffffc0204c32 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204c9a:	03000513          	li	a0,48
ffffffffc0204c9e:	85a6                	mv	a1,s1
ffffffffc0204ca0:	e03e                	sd	a5,0(sp)
ffffffffc0204ca2:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204ca4:	85a6                	mv	a1,s1
ffffffffc0204ca6:	07800513          	li	a0,120
ffffffffc0204caa:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204cac:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204cae:	6782                	ld	a5,0(sp)
ffffffffc0204cb0:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204cb2:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204cb6:	bfb5                	j	ffffffffc0204c32 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204cb8:	000a3403          	ld	s0,0(s4)
ffffffffc0204cbc:	008a0713          	addi	a4,s4,8
ffffffffc0204cc0:	e03a                	sd	a4,0(sp)
ffffffffc0204cc2:	14040263          	beqz	s0,ffffffffc0204e06 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204cc6:	0fb05763          	blez	s11,ffffffffc0204db4 <vprintfmt+0x2d8>
ffffffffc0204cca:	02d00693          	li	a3,45
ffffffffc0204cce:	0cd79163          	bne	a5,a3,ffffffffc0204d90 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cd2:	00044783          	lbu	a5,0(s0)
ffffffffc0204cd6:	0007851b          	sext.w	a0,a5
ffffffffc0204cda:	cf85                	beqz	a5,ffffffffc0204d12 <vprintfmt+0x236>
ffffffffc0204cdc:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204ce0:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204ce4:	000c4563          	bltz	s8,ffffffffc0204cee <vprintfmt+0x212>
ffffffffc0204ce8:	3c7d                	addiw	s8,s8,-1
ffffffffc0204cea:	036c0263          	beq	s8,s6,ffffffffc0204d0e <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204cee:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204cf0:	0e0c8e63          	beqz	s9,ffffffffc0204dec <vprintfmt+0x310>
ffffffffc0204cf4:	3781                	addiw	a5,a5,-32
ffffffffc0204cf6:	0ef47b63          	bgeu	s0,a5,ffffffffc0204dec <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204cfa:	03f00513          	li	a0,63
ffffffffc0204cfe:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d00:	000a4783          	lbu	a5,0(s4)
ffffffffc0204d04:	3dfd                	addiw	s11,s11,-1
ffffffffc0204d06:	0a05                	addi	s4,s4,1
ffffffffc0204d08:	0007851b          	sext.w	a0,a5
ffffffffc0204d0c:	ffe1                	bnez	a5,ffffffffc0204ce4 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204d0e:	01b05963          	blez	s11,ffffffffc0204d20 <vprintfmt+0x244>
ffffffffc0204d12:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204d14:	85a6                	mv	a1,s1
ffffffffc0204d16:	02000513          	li	a0,32
ffffffffc0204d1a:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204d1c:	fe0d9be3          	bnez	s11,ffffffffc0204d12 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204d20:	6a02                	ld	s4,0(sp)
ffffffffc0204d22:	bbd5                	j	ffffffffc0204b16 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204d24:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204d26:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204d2a:	01174463          	blt	a4,a7,ffffffffc0204d32 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204d2e:	08088d63          	beqz	a7,ffffffffc0204dc8 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204d32:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204d36:	0a044d63          	bltz	s0,ffffffffc0204df0 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204d3a:	8622                	mv	a2,s0
ffffffffc0204d3c:	8a66                	mv	s4,s9
ffffffffc0204d3e:	46a9                	li	a3,10
ffffffffc0204d40:	bdcd                	j	ffffffffc0204c32 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204d42:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d46:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204d48:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204d4a:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204d4e:	8fb5                	xor	a5,a5,a3
ffffffffc0204d50:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d54:	02d74163          	blt	a4,a3,ffffffffc0204d76 <vprintfmt+0x29a>
ffffffffc0204d58:	00369793          	slli	a5,a3,0x3
ffffffffc0204d5c:	97de                	add	a5,a5,s7
ffffffffc0204d5e:	639c                	ld	a5,0(a5)
ffffffffc0204d60:	cb99                	beqz	a5,ffffffffc0204d76 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204d62:	86be                	mv	a3,a5
ffffffffc0204d64:	00000617          	auipc	a2,0x0
ffffffffc0204d68:	1ec60613          	addi	a2,a2,492 # ffffffffc0204f50 <etext+0x28>
ffffffffc0204d6c:	85a6                	mv	a1,s1
ffffffffc0204d6e:	854a                	mv	a0,s2
ffffffffc0204d70:	0ce000ef          	jal	ra,ffffffffc0204e3e <printfmt>
ffffffffc0204d74:	b34d                	j	ffffffffc0204b16 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204d76:	00002617          	auipc	a2,0x2
ffffffffc0204d7a:	07260613          	addi	a2,a2,114 # ffffffffc0206de8 <default_pmm_manager+0x1170>
ffffffffc0204d7e:	85a6                	mv	a1,s1
ffffffffc0204d80:	854a                	mv	a0,s2
ffffffffc0204d82:	0bc000ef          	jal	ra,ffffffffc0204e3e <printfmt>
ffffffffc0204d86:	bb41                	j	ffffffffc0204b16 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204d88:	00002417          	auipc	s0,0x2
ffffffffc0204d8c:	05840413          	addi	s0,s0,88 # ffffffffc0206de0 <default_pmm_manager+0x1168>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d90:	85e2                	mv	a1,s8
ffffffffc0204d92:	8522                	mv	a0,s0
ffffffffc0204d94:	e43e                	sd	a5,8(sp)
ffffffffc0204d96:	0e2000ef          	jal	ra,ffffffffc0204e78 <strnlen>
ffffffffc0204d9a:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204d9e:	01b05b63          	blez	s11,ffffffffc0204db4 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204da2:	67a2                	ld	a5,8(sp)
ffffffffc0204da4:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204da8:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204daa:	85a6                	mv	a1,s1
ffffffffc0204dac:	8552                	mv	a0,s4
ffffffffc0204dae:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204db0:	fe0d9ce3          	bnez	s11,ffffffffc0204da8 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204db4:	00044783          	lbu	a5,0(s0)
ffffffffc0204db8:	00140a13          	addi	s4,s0,1
ffffffffc0204dbc:	0007851b          	sext.w	a0,a5
ffffffffc0204dc0:	d3a5                	beqz	a5,ffffffffc0204d20 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204dc2:	05e00413          	li	s0,94
ffffffffc0204dc6:	bf39                	j	ffffffffc0204ce4 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204dc8:	000a2403          	lw	s0,0(s4)
ffffffffc0204dcc:	b7ad                	j	ffffffffc0204d36 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204dce:	000a6603          	lwu	a2,0(s4)
ffffffffc0204dd2:	46a1                	li	a3,8
ffffffffc0204dd4:	8a2e                	mv	s4,a1
ffffffffc0204dd6:	bdb1                	j	ffffffffc0204c32 <vprintfmt+0x156>
ffffffffc0204dd8:	000a6603          	lwu	a2,0(s4)
ffffffffc0204ddc:	46a9                	li	a3,10
ffffffffc0204dde:	8a2e                	mv	s4,a1
ffffffffc0204de0:	bd89                	j	ffffffffc0204c32 <vprintfmt+0x156>
ffffffffc0204de2:	000a6603          	lwu	a2,0(s4)
ffffffffc0204de6:	46c1                	li	a3,16
ffffffffc0204de8:	8a2e                	mv	s4,a1
ffffffffc0204dea:	b5a1                	j	ffffffffc0204c32 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204dec:	9902                	jalr	s2
ffffffffc0204dee:	bf09                	j	ffffffffc0204d00 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204df0:	85a6                	mv	a1,s1
ffffffffc0204df2:	02d00513          	li	a0,45
ffffffffc0204df6:	e03e                	sd	a5,0(sp)
ffffffffc0204df8:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204dfa:	6782                	ld	a5,0(sp)
ffffffffc0204dfc:	8a66                	mv	s4,s9
ffffffffc0204dfe:	40800633          	neg	a2,s0
ffffffffc0204e02:	46a9                	li	a3,10
ffffffffc0204e04:	b53d                	j	ffffffffc0204c32 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204e06:	03b05163          	blez	s11,ffffffffc0204e28 <vprintfmt+0x34c>
ffffffffc0204e0a:	02d00693          	li	a3,45
ffffffffc0204e0e:	f6d79de3          	bne	a5,a3,ffffffffc0204d88 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204e12:	00002417          	auipc	s0,0x2
ffffffffc0204e16:	fce40413          	addi	s0,s0,-50 # ffffffffc0206de0 <default_pmm_manager+0x1168>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204e1a:	02800793          	li	a5,40
ffffffffc0204e1e:	02800513          	li	a0,40
ffffffffc0204e22:	00140a13          	addi	s4,s0,1
ffffffffc0204e26:	bd6d                	j	ffffffffc0204ce0 <vprintfmt+0x204>
ffffffffc0204e28:	00002a17          	auipc	s4,0x2
ffffffffc0204e2c:	fb9a0a13          	addi	s4,s4,-71 # ffffffffc0206de1 <default_pmm_manager+0x1169>
ffffffffc0204e30:	02800513          	li	a0,40
ffffffffc0204e34:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204e38:	05e00413          	li	s0,94
ffffffffc0204e3c:	b565                	j	ffffffffc0204ce4 <vprintfmt+0x208>
...
ffffffffc0204e52:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204e54:	c89ff0ef          	jal	ra,ffffffffc0204adc <vprintfmt>
}
...
strlen(const char *s) {
ffffffffc0204e62:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204e64:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204e66:	cb81                	beqz	a5,ffffffffc0204e76 <strlen+0x18>
        cnt ++;
ffffffffc0204e68:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204e6a:	00a707b3          	add	a5,a4,a0
ffffffffc0204e6e:	0007c783          	lbu	a5,0(a5)
ffffffffc0204e72:	fbfd                	bnez	a5,ffffffffc0204e68 <strlen+0xa>
...
strnlen(const char *s, size_t len) {
    size_t cnt = 0;
ffffffffc0204e78:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e7a:	e589                	bnez	a1,ffffffffc0204e84 <strnlen+0xc>
ffffffffc0204e7c:	a811                	j	ffffffffc0204e90 <strnlen+0x18>
        cnt ++;
ffffffffc0204e7e:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e80:	00f58863          	beq	a1,a5,ffffffffc0204e90 <strnlen+0x18>
ffffffffc0204e84:	00f50733          	add	a4,a0,a5
ffffffffc0204e88:	00074703          	lbu	a4,0(a4)
ffffffffc0204e8c:	fb6d                	bnez	a4,ffffffffc0204e7e <strnlen+0x6>
ffffffffc0204e8e:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204e90:	852e                	mv	a0,a1
ffffffffc0204e92:	8082                	ret

ffffffffc0204e94 <strcpy>:
char *
...
ffffffffc0204ea2:	fb75                	bnez	a4,ffffffffc0204e96 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204eaa:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204eae:	cb89                	beqz	a5,ffffffffc0204ec0 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204eb0:	0505                	addi	a0,a0,1
ffffffffc0204eb2:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204eb4:	fee789e3          	beq	a5,a4,ffffffffc0204ea6 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204eb8:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204ebc:	9d19                	subw	a0,a0,a4
ffffffffc0204ebe:	8082                	ret
ffffffffc0204ec0:	4501                	li	a0,0
ffffffffc0204ec2:	bfed                	j	ffffffffc0204ebc <strcmp+0x16>

ffffffffc0204ec4 <strchr>:
...
ffffffffc0204ec8:	c799                	beqz	a5,ffffffffc0204ed6 <strchr+0x12>
        if (*s == c) {
ffffffffc0204eca:	00f58763          	beq	a1,a5,ffffffffc0204ed8 <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204ece:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204ed2:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204ed4:	fbfd                	bnez	a5,ffffffffc0204eca <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204eda:	ca01                	beqz	a2,ffffffffc0204eea <memset+0x10>
ffffffffc0204edc:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204ede:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204ee0:	0785                	addi	a5,a5,1
ffffffffc0204ee2:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204ee6:	fec79de3          	bne	a5,a2,ffffffffc0204ee0 <memset+0x6>
    }
    return s;
...
ffffffffc0204eec <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204eec:	ca19                	beqz	a2,ffffffffc0204f02 <memcpy+0x16>
ffffffffc0204eee:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204ef0:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204ef2:	0005c703          	lbu	a4,0(a1)
ffffffffc0204ef6:	0585                	addi	a1,a1,1
ffffffffc0204ef8:	0785                	addi	a5,a5,1
ffffffffc0204efa:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204efe:	fec59ae3          	bne	a1,a2,ffffffffc0204ef2 <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204f04:	c205                	beqz	a2,ffffffffc0204f24 <memcmp+0x20>
ffffffffc0204f06:	962e                	add	a2,a2,a1
ffffffffc0204f08:	a019                	j	ffffffffc0204f0e <memcmp+0xa>
ffffffffc0204f0a:	00c58d63          	beq	a1,a2,ffffffffc0204f24 <memcmp+0x20>
        if (*s1 != *s2) {
...
ffffffffc0204f12:	0005c703          	lbu	a4,0(a1)
        ...
        s1 ++, s2 ++;
ffffffffc0204f16:	0505                	addi	a0,a0,1
ffffffffc0204f18:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204f1a:	fee788e3          	beq	a5,a4,ffffffffc0204f0a <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204f1e:	40e7853b          	subw	a0,a5,a4
ffffffffc0204f22:	8082                	ret
    }
    return 0;
ffffffffc0204f24:	4501                	li	a0,0
}
